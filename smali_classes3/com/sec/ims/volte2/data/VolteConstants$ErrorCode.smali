...
.field public static final CALL_EPDN_REJECT_AND_VOLTE_RETRY:I = 0x466
...
.field public static final CALL_INVITE_TIMEOUT_NR:I = 0x465
...
.field public static final CLIENT_ERROR_AUDIO_CREATE_FAILURE:I = 0x3ef
...
.field public static final DSDA_FALLBACK_DSDS:I = 0x5e4
...
.field public static final IDC_ADC_REQUEST_FAILED:I = 0x1b59
...
.field public static final VONR_NOT_POSSIBLE:I = 0x5e3
...
.method public static toString(I)Ljava/lang/String;
    ...
    :pswitch_0
    const-string p0, "Forked Call Completed Elsewhere"

    return-object p0

    :pswitch_1
    const-string p0, "CANCEL wtih reason Text = DECLINED"

    return-object p0

    :pswitch_2
    const-string p0, "Emergency calls over WiFi not allowed in this location"

    return-object p0

    :pswitch_3
    const-string p0, "You have an active call on another soft phone that must complete before you can use this soft phone"

    return-object p0

    :pswitch_4
    const-string p0, "Other secondary device in use"

    return-object p0

    :pswitch_5
    const-string p0, "Simultaneous call limit has already been reached"

    return-object p0

    :pswitch_6
    const-string p0, "Cancel Service not allowed in this location"

    return-object p0

    :pswitch_7
    const-string p0, "Forbbiden Service not allowed in this location"

    return-object p0

    :pswitch_8
    const-string p0, "Call has been transferred to another device"
    ...
    :pswitch_a
    const-string p0, "Pulled By Another Device"

    return-object p0

    :pswitch_b
    const-string p0, "Cancel Call Busy"

    return-object p0

    :pswitch_c
    const-string p0, "Cancel Call Completion"

    return-object p0

    :pswitch_d
    const-string p0, "Call failed (Service unavailable no popup)"
    ...
    :pswitch_10
    const-string p0, "Call temporal unavailable with 415 cause"

    return-object p0

    :pswitch_11
    const-string p0, "Call temporal unavailable with 380 cause"

    return-object p0

    :pswitch_12
    const-string p0, "Call 5xx error response"
    ...
    :pswitch_16
    const-string p0, "Call request failed"

    return-object p0

    :pswitch_17
    const-string p0, "Request type not allowed"

    return-object p0

    :pswitch_18
    const-string p0, "Invalid remote address"
    ...
    :sswitch_0
    const-string p0, "21:\"call rejected\":\"ODB: Call is released by operator specific barring.\""

    return-object p0

    :sswitch_1
    const-string p0, "Incompatible destination"
    ...
    :sswitch_3
    const-string p0, "403 response for registering"

    return-object p0

    :sswitch_4
    const-string p0, "Internal server error with Restoration"

    return-object p0

    :sswitch_5
    const-string p0, "Invite Timeout Nr"

    return-object p0

    :sswitch_6
    const-string p0, "Invite Timeout"

    return-object p0

    :sswitch_7
    const-string p0, "Cannot connect HD call"

    return-object p0

    :sswitch_8
    const-string p0, "Call resume failed"

    return-object p0

    :sswitch_9
    const-string p0, "Call hold failed"

    return-object p0

    :sswitch_a
    const-string p0, "Call switch rejected"

    return-object p0

    :sswitch_b
    const-string p0, "Call switch failure"

    return-object p0

    :sswitch_c
    const-string p0, "Call rejected due to active CS Call"

    return-object p0

    :sswitch_d
    const-string p0, "End call NW handover"

    return-object p0

    :sswitch_e
    const-string p0, "Remove user from session failure"

    return-object p0

    :sswitch_f
    const-string p0, "Add user to session failure"

    return-object p0

    :sswitch_10
    const-string p0, "Start conference call failure"

    return-object p0

    :sswitch_11
    const-string p0, "Session time out"

    return-object p0

    :sswitch_12
    const-string p0, "ACK for 200 OK but call terminated"

    return-object p0

    :sswitch_13
    const-string p0, "Session aborted"

    return-object p0

    :sswitch_14
    const-string p0, "call not allowed"

    return-object p0

    :sswitch_15
    const-string p0, "Call rejected"
    ...
    :sswitch_1a
    const-string p0, "Media not supported"

    return-object p0

    :sswitch_1b
    const-string p0, "ACK wait timer timeout"
    ...
    :sswitch_1d
    const-string p0, "Call alternative services"

    return-object p0

    :cond_0
    const-string p0, "SERVICE_UNAVAILABLE With IMS OUTAGE"

    return-object p0

    :cond_1
    const-string p0, "Timer_VZW expired"
    ...
    :cond_3
    const-string p0, "Call not acceptable divert"

    return-object p0

    :cond_4
    const-string p0, "Client error"
