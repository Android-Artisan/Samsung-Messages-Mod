...
.field private static final REGEX_PHONE_BASIC1:Ljava/lang/String; = "(?<!\\d)(\\+\\s*)?(\\d){1,3}\\s*(-|\\.)\\s*(\\d){1,3}\\s*(-|\\.)\\s*(\\d)+"

.field private static final REGEX_PHONE_BASIC2:Ljava/lang/String; = "(\\+)\\s*(\\d){1,3}\\s*([()0O\\[\\]]{3})\\s*(\\d)+\\s*(\\d)+"

.field private static final REGEX_PHONE_BASIC3:Ljava/lang/String; = "(?<!\\d)(((\\d{1,3})(\\s\\d)?(-))(\\d{2,4})((-)?)(\\d{2,6}))(?!\\d)"

.field private static final REGEX_PHONE_BASIC4:Ljava/lang/String; = "(?<![\\d-])(\\d{1,3})(-)(\\d{1,2})(-)((\\d|\\s){3,5})(-)((\\d|\\s){3,6})"
...
.method static constructor <clinit>()V
    ...
    const-string v0, "(?<!\\d)(\\+\\s*)?(\\d){1,3}\\s*(-|\\.)\\s*(\\d){1,3}\\s*(-|\\.)\\s*(\\d)+"
    ...
    const-string v0, "(?<!\\d)(((\\d{1,3})(\\s\\d)?(-))(\\d{2,4})((-)?)(\\d{2,6}))(?!\\d)"
    ...
    const-string v0, "(?<![\\d-])(\\d{1,3})(-)(\\d{1,2})(-)((\\d|\\s){3,5})(-)((\\d|\\s){3,6})"
...
.method private static correctPhoneNumberZeroBracket(Lcom/samsung/android/ocr/MOCRResult$Line;Ljava/util/regex/Matcher;II)V
    ...
    const-string p2, "Zero correction at pos "

    const-string p3, " in word "

    invoke-static {p0, p2, p3}, LU4/l;->s(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public static validatePhoneLine(Lcom/samsung/android/ocr/MOCRResult$Page;)V
    ...
    invoke-static {v2, v8, v10, v11}, LA0/a;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v7, v11, v2, v12}, Lcom/samsung/android/ocr/stride/postocr/entity/CorrectionBase;->joinWords(Lcom/samsung/android/ocr/MOCRResult$Line;IILcom/samsung/android/ocr/stride/postocr/entity/CorrectionBase$RegexActions;)V

    invoke-static {v10, v14}, Lcom/samsung/android/ocr/MOCRLog;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v11, "PAT_REGEX_PHONE_BASIC1 match: "
    ...
    invoke-static {v7, v15, v11}, Lcom/samsung/android/ocr/stride/postocr/entity/CorrectionBase;->joinWords(Lcom/samsung/android/ocr/MOCRResult$Line;II)V
    ...
    const-string v11, "PAT_REGEX_PHONE_BASIC2 match: "
    ...
    const-string v11, "PAT_REGEX_PHONE_BASIC3 match: "
    ...
    invoke-static {v7, v11, v9}, Lcom/samsung/android/ocr/stride/postocr/entity/CorrectionBase;->joinWords(Lcom/samsung/android/ocr/MOCRResult$Line;II)V
    ...
    const-string v15, "PAT_REGEX_PHONE_BASIC4 match: "

    invoke-static {v2, v8, v11, v15}, LA0/a;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v11, v2}, Lcom/samsung/android/ocr/MOCRLog;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v10, v7}, Lcom/samsung/android/ocr/stride/postocr/entity/CorrectionBase;->getMatchingIds(Ljava/util/regex/Matcher;Lcom/samsung/android/ocr/MOCRResult$Line;)[I
    ...
    invoke-static {v7, v8, v2}, Lcom/samsung/android/ocr/stride/postocr/entity/CorrectionBase;->joinWords(Lcom/samsung/android/ocr/MOCRResult$Line;II)V

    invoke-static {v11, v14}, Lcom/samsung/android/ocr/MOCRLog;->i(Ljava/lang/String;Ljava/lang/String;)I
