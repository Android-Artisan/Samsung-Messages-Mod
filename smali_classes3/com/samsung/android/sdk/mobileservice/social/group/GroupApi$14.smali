...
.method public onFailure(JLjava/lang/String;)V
    ...
    const-string/jumbo v1, "requestGroupWithInvitationList onFailure : code=["
    ...
    invoke-static {v0, v1}, Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;->access$6500(Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;Ljava/lang/String;)V

    iget-object v0, p0, Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi$14;->this$0:Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;

    invoke-static {v0}, Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;->access$6600(Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;)J
    ...
    iget-object p0, p0, Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi$14;->val$callback:Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi$GroupResultCallback;
...
.method public onFailureWithBundle(Landroid/os/Bundle;)V
    ...
    const-string/jumbo v5, "requestGroupWithInvitationList onFailureWithBundle : code=["
    ...
    invoke-static {v3, v5}, Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;->access$6700(Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;Ljava/lang/String;)V
...
.method public onSuccess(Ljava/util/List;)V
    ...
    const-string/jumbo v2, "requestGroupWithInvitationList onSuccess "

    invoke-static {v1, v2}, Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;->access$6200(Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;Ljava/lang/String;)V
    ...
    invoke-static {v6, v7, v9, v8, v10}, Lvf/a;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-static {v4, v6}, Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;->access$6300(Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v10, v5}, Landroid/os/BaseBundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    const-string/jumbo v10, "requesterId"

    invoke-virtual {v3, v10, v5}, Landroid/os/BaseBundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v13

    const-string/jumbo v10, "requesterName"

    invoke-virtual {v3, v10, v5}, Landroid/os/BaseBundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v14

    const-string/jumbo v10, "requesterImageUrl"

    invoke-virtual {v3, v10, v5}, Landroid/os/BaseBundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v15

    const-string/jumbo v10, "requesterImageFileUri"

    invoke-virtual {v3, v10, v5}, Landroid/os/BaseBundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    const-string/jumbo v11, "requesterImageContentUri"

    invoke-virtual {v3, v11, v5}, Landroid/os/BaseBundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    const-string/jumbo v5, "requestedTime"
    ...
    invoke-virtual {v3, v5, v1, v2}, Landroid/os/BaseBundle;->getLong(Ljava/lang/String;J)J
    ...
    invoke-static {v3, v0}, Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;->access$6400(Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi;Ljava/lang/String;)V
    ...
    iget-object v1, v1, Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi$14;->val$callback:Lcom/samsung/android/sdk/mobileservice/social/group/GroupApi$GroupResultCallback;
    ...
    invoke-direct {v2, v3, v0}, Lcom/samsung/android/sdk/mobileservice/social/group/result/GroupInvitationListResult;-><init>(Lcom/samsung/android/sdk/mobileservice/common/result/CommonResultStatus;Ljava/util/List;)V
