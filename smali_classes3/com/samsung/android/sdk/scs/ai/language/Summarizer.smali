...
.field protected mServiceExecutor:Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/scs/ai/language/Summarizer;->createExecutor(Landroid/content/Context;)V
...
.method public static synthetic c(Lcom/samsung/android/sdk/scs/ai/language/Summarizer;Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/SummaryOnDeviceType;Ljava/util/Map;Lcom/samsung/android/sdk/scs/ai/language/service/LlmServiceObserver2;)V
    .locals 0
...
.method private synthetic lambda$getTokenCount$2(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/SummarizeLevel;Lcom/samsung/android/sdk/scs/ai/language/SummarizeSubTask;Ljava/util/Map;Lcom/samsung/android/sdk/scs/ai/language/service/LlmServiceObserver2;)V
    ...
    invoke-virtual {v0}, Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;->getService()Lcom/samsung/android/sivs/ai/sdkcommon/language/f0;
    ...
    check-cast v2, Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;
    ...
    invoke-virtual/range {v2 .. v8}, Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;->U1(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/service/LlmServiceObserver2;Ljava/util/Map;)V
    :try_end_0
...
.method private synthetic lambda$release$3(Lcom/samsung/android/sdk/scs/ai/language/service/LlmServiceObserver2;)V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;->getService()Lcom/samsung/android/sivs/ai/sdkcommon/language/f0;

    move-result-object p0

    check-cast p0, Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;

    invoke-virtual {p0}, Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;->a()V
...
.method private synthetic lambda$summarize$0(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/SummarizeLevel;Lcom/samsung/android/sdk/scs/ai/language/SummarizeSubTask;Ljava/util/Map;Lcom/samsung/android/sdk/scs/ai/language/service/LlmServiceObserver2;)V
    ...
    invoke-virtual/range {v2 .. v8}, Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;->i0(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/service/LlmServiceObserver2;Ljava/util/Map;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private synthetic lambda$summarizeOnDevice$1(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/SummaryOnDeviceType;Ljava/util/Map;Lcom/samsung/android/sdk/scs/ai/language/service/LlmServiceObserver2;)V
    .locals 8

    :try_start_0
    iget-object v0, p0, Lcom/samsung/android/sdk/scs/ai/language/Summarizer;->mServiceExecutor:Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;

    iget-object v0, v0, Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;->context:Landroid/content/Context;

    const-string v1, "FEATURE_AI_ONDEVICE_SUMMARY_EXTRA_PROMPT"
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;->x0(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/service/LlmServiceObserver2;Ljava/util/Map;)V
    ...
    :cond_0
    iget-object p4, p0, Lcom/samsung/android/sdk/scs/ai/language/Summarizer;->mServiceExecutor:Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;

    invoke-virtual {p4}, Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;->getService()Lcom/samsung/android/sivs/ai/sdkcommon/language/f0;
    ...
    check-cast p4, Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;

    invoke-virtual {p4, p0, p2, p1, p5}, Lcom/samsung/android/sivs/ai/sdkcommon/language/d0;->Z1(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/service/LlmServiceObserver2;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public createExecutor(Landroid/content/Context;)V
    ...
    const-string p1, "FEATURE_AI_GEN_SUMMARY"
...
.method public getTokenCount(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/SummarizeLevel;Lcom/samsung/android/sdk/scs/ai/language/SummarizeSubTask;Ljava/util/Map;)Lcom/samsung/android/sdk/scs/base/tasks/Task;
    ...
    iget-object v10, v8, Lcom/samsung/android/sdk/scs/ai/language/Summarizer;->featureName:Ljava/lang/String;
    ...
    new-instance v12, Lcom/samsung/android/sdk/scs/ai/language/e;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/samsung/android/sdk/scs/ai/language/e;-><init>(Lcom/samsung/android/sdk/scs/ai/language/Summarizer;Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/SummarizeLevel;Lcom/samsung/android/sdk/scs/ai/language/SummarizeSubTask;Ljava/util/Map;I)V
    ...
    invoke-direct {v9, v10, v11, v12, v0}, Lcom/samsung/android/sdk/scs/ai/language/service/LlmServiceRunnable;-><init>(Ljava/lang/String;ZLjava/util/function/Consumer;Ljava/util/function/Function;)V

    .line 4
    iget-object v0, v8, Lcom/samsung/android/sdk/scs/ai/language/Summarizer;->mServiceExecutor:Lcom/samsung/android/sdk/scs/ai/language/service/SummarizationServiceExecutor;
...
.method public release()V
    ...
    iget-object v1, p0, Lcom/samsung/android/sdk/scs/ai/language/Summarizer;->featureName:Ljava/lang/String;
...
.method public summarizeOnDevice(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/SummaryOnDeviceType;)Lcom/samsung/android/sdk/scs/base/tasks/Task;
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/samsung/android/sdk/scs/ai/language/Summarizer;->summarizeOnDevice(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/SummaryOnDeviceType;Ljava/util/Map;)Lcom/samsung/android/sdk/scs/base/tasks/Task;
...
.method public summarizeOnDevice(Lcom/samsung/android/sdk/scs/ai/language/AppInfo;Ljava/lang/String;Lcom/samsung/android/sdk/scs/ai/language/SummaryOnDeviceType;Ljava/util/Map;)Lcom/samsung/android/sdk/scs/base/tasks/Task;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
