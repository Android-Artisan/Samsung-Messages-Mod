.class public final Lcom/samsung/android/sdk/aisuggestion/schema/routines/$$__AppSearch__NudgeRoutineSuggestionDataDocument;
...
# static fields
.field public static final SCHEMA_NAME:Ljava/lang/String; = "ContextualInsightData:NudgeRoutineSuggestion"
...
# virtual methods
.method public fromGenericDocument(Lh/z;Ljava/util/Map;)Lcom/samsung/android/sdk/aisuggestion/schema/routines/NudgeRoutineSuggestionDataDocument;
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 24
    :goto_5
    const-string v3, "nudgeRoutineIcon"
    ...
    .line 26
    :goto_6
    const-string/jumbo v3, "suggestedAction"
    ...
    .line 28
    :goto_7
    new-instance v0, Lcom/samsung/android/sdk/aisuggestion/schema/routines/NudgeRoutineSuggestionDataDocument;
    ...
    invoke-direct/range {v3 .. v10}, Lcom/samsung/android/sdk/aisuggestion/schema/routines/NudgeRoutineSuggestionDataDocument;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/sdk/aisuggestion/schema/core/ImageResourceDataDocument;Lcom/samsung/android/sdk/aisuggestion/schema/core/PotentialActionDataDocument;)V
...
.method public bridge synthetic fromGenericDocument(Lh/z;Ljava/util/Map;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/sdk/aisuggestion/schema/routines/$$__AppSearch__NudgeRoutineSuggestionDataDocument;->fromGenericDocument(Lh/z;Ljava/util/Map;)Lcom/samsung/android/sdk/aisuggestion/schema/routines/NudgeRoutineSuggestionDataDocument;
...
.method public getSchema()Lh/u;
    ...
    const-string p0, "ContextualInsightData:NudgeRoutineSuggestion"
    ...
    const-string v4, "nudgeRoutineIcon"

    const-string v5, "ContextualInsightData:ImageResource"

    invoke-static {p0, v0, v4, v5, v1}, Lf1/d;->f(Lh/h;Lh/t;Ljava/lang/String;Ljava/lang/String;I)Lh/k;

    move-result-object v0

    iput-boolean v2, v0, Lh/k;->d:Z

    const-string/jumbo v4, "suggestedAction"
...
.method public toGenericDocument(Lcom/samsung/android/sdk/aisuggestion/schema/routines/NudgeRoutineSuggestionDataDocument;)Lh/z;
    .locals 4
    ...
    const-string v2, "ContextualInsightData:NudgeRoutineSuggestion"
    ...
    .line 15
    :cond_4
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/routines/NudgeRoutineSuggestionDataDocument;->getDescription()Ljava/lang/String;
    ...
    .line 17
    :cond_5
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/routines/NudgeRoutineSuggestionDataDocument;->getNudgeRoutineIcon()Lcom/samsung/android/sdk/aisuggestion/schema/core/ImageResourceDataDocument;
    ...
    .line 20
    :cond_6
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/routines/NudgeRoutineSuggestionDataDocument;->getSuggestedAction()Lcom/samsung/android/sdk/aisuggestion/schema/core/PotentialActionDataDocument;
    ...
    .line 22
    const-string/jumbo v0, "suggestedAction"
...
.method public bridge synthetic toGenericDocument(Ljava/lang/Object;)Lh/z;
    ...
    .line 1
    check-cast p1, Lcom/samsung/android/sdk/aisuggestion/schema/routines/NudgeRoutineSuggestionDataDocument;

    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/aisuggestion/schema/routines/$$__AppSearch__NudgeRoutineSuggestionDataDocument;->toGenericDocument(Lcom/samsung/android/sdk/aisuggestion/schema/routines/NudgeRoutineSuggestionDataDocument;)Lh/z;
