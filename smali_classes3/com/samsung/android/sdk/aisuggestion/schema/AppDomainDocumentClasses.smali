...
.method static constructor <clinit>()V
    ...
    const-class v46, Lcom/samsung/android/sdk/aisuggestion/schema/message/SuspiciousMessageBlockReportDataDocument;

    const-class v47, Lcom/samsung/android/sdk/aisuggestion/schema/message/SuspiciousMessageBlockSuggestionDataDocument;
    ...
    const-class v23, Lcom/samsung/android/sdk/aisuggestion/schema/wallet/gift/ImminentCouponAlertDataDocument;

    const-class v24, Lcom/samsung/android/sdk/aisuggestion/schema/wallet/gift/ReceivedGiftDataDocument;

    const-class v25, Lcom/samsung/android/sdk/aisuggestion/schema/wallet/ticket/EventTicketDataDocument;

    const-class v26, Lcom/samsung/android/sdk/aisuggestion/schema/wallet/ticket/TravelTicketDataDocument;

    const-class v27, Lcom/samsung/android/sdk/aisuggestion/schema/wallet/transit/TransitBalanceReminderDataDocument;

    const-class v28, Lcom/samsung/android/sdk/aisuggestion/schema/wallet/transit/TransitKrDataDocument;

    const-class v29, Lcom/samsung/android/sdk/aisuggestion/schema/wellbeing/PhoneWeeklyComfortCareDataDocument;

    const-class v30, Lcom/samsung/android/sdk/aisuggestion/schema/wellbeing/PhoneWeeklyUsageDataDocument;

    const-class v31, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthEnergyScoreDataDocument;

    const-class v32, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthDailyActivityDataDocument;

    const-class v33, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthMindfulnessSuggestionDataDocument;

    const-class v34, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthSleepBedtimeDataDocument;

    const-class v35, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthSleepCoachingDataDocument;

    const-class v36, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthSleepScoreDataDocument;

    const-class v37, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthMedicationDataDocument;

    const-class v38, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthWaterDataDocument;

    const-class v39, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthBIADataDocument;

    const-class v40, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthBloodPressureDataDocument;

    const-class v41, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthExerciseWeeklyReportDataDocument;

    const-class v42, Lcom/samsung/android/sdk/aisuggestion/schema/health/HealthExerciseWorkoutResultDataDocument;

    const-class v43, Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;

    const-class v44, Lcom/samsung/android/sdk/aisuggestion/schema/sassistant/SAssistantTravelTicketDataDocument;

    const-class v45, Lcom/samsung/android/sdk/aisuggestion/schema/map/TimeToLeaveSuggestionDataDocument;

    const-class v48, Lcom/samsung/android/sdk/aisuggestion/schema/message/DeliveryMessageDailyReportDataDocument;

    const-class v49, Lcom/samsung/android/sdk/aisuggestion/schema/message/DeliveryMessageDataDocument;
