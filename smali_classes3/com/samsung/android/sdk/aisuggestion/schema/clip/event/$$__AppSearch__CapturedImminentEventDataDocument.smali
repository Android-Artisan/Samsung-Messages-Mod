.class public final Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/$$__AppSearch__CapturedImminentEventDataDocument;
...
# static fields
.field public static final SCHEMA_NAME:Ljava/lang/String; = "ContextualInsightData:CapturedImminentEvent"
...
# virtual methods
.method public fromGenericDocument(Lh/z;Ljava/util/Map;)Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;
    .locals 21
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 26
    :goto_6
    const-string v2, "eventStartingTime"
    ...
    .line 29
    :goto_7
    const-string v2, "eventStartingDate"
    ...
    .line 32
    :goto_8
    const-string v2, "eventEndingTime"
    ...
    .line 35
    :goto_9
    const-string v2, "eventEndingDate"
    ...
    .line 41
    :goto_b
    new-instance v5, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;
    ...
    invoke-direct/range {v2 .. v13}, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/String;)V

    .line 42
    iput-object v1, v14, Lcom/samsung/android/sdk/aisuggestion/schema/core/AppDomainDataDocument;->id:Ljava/lang/String;
    ...
    .line 44
    iput-object v15, v14, Lcom/samsung/android/sdk/aisuggestion/schema/core/AppDomainDataDocument;->refreshDocumentAction:Lcom/samsung/android/sdk/aisuggestion/schema/core/PotentialActionDataDocument;

    move-object/from16 v2, v16

    .line 45
    iput-object v2, v14, Lcom/samsung/android/sdk/aisuggestion/schema/core/AppDomainDataDocument;->contentId:Ljava/lang/String;
...
.method public bridge synthetic fromGenericDocument(Lh/z;Ljava/util/Map;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/$$__AppSearch__CapturedImminentEventDataDocument;->fromGenericDocument(Lh/z;Ljava/util/Map;)Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;
...
.method public getSchema()Lh/u;
    ...
    const-string p0, "ContextualInsightData:CapturedImminentEvent"
    ...
    const-string v3, "eventStartingTime"
    ...
    const-string v3, "eventStartingDate"
    ...
    const-string v3, "eventEndingTime"
    ...
    const-string v3, "eventEndingDate"
...
.method public toGenericDocument(Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;)Lh/z;
    .locals 5
    ...
    const-string v2, "ContextualInsightData:CapturedImminentEvent"
    ...
    .line 15
    :cond_4
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;->getEventTitle()Ljava/lang/String;
    ...
    .line 17
    :cond_5
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;->getEventLocation()Ljava/lang/String;
    ...
    .line 19
    :cond_6
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;->getEventStartingTime()Ljava/lang/Long;
    ...
    const-string v0, "eventStartingTime"

    invoke-virtual {p0, v0, v3}, Lh/z$a;->f(Ljava/lang/String;[J)Lh/z$a;

    .line 21
    :cond_7
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;->getEventStartingDate()Ljava/lang/Long;
    ...
    const-string v0, "eventStartingDate"

    invoke-virtual {p0, v0, v3}, Lh/z$a;->f(Ljava/lang/String;[J)Lh/z$a;

    .line 23
    :cond_8
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;->getEventEndingTime()Ljava/lang/Long;
    ...
    const-string v0, "eventEndingTime"

    invoke-virtual {p0, v0, v3}, Lh/z$a;->f(Ljava/lang/String;[J)Lh/z$a;

    .line 25
    :cond_9
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;->getEventEndingDate()Ljava/lang/Long;
    ...
    const-string v0, "eventEndingDate"

    invoke-virtual {p0, v0, v2}, Lh/z$a;->f(Ljava/lang/String;[J)Lh/z$a;

    .line 27
    :cond_a
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;->getImageUri()Ljava/lang/String;
...
.method public bridge synthetic toGenericDocument(Ljava/lang/Object;)Lh/z;
    ...
    .line 1
    check-cast p1, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;

    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/$$__AppSearch__CapturedImminentEventDataDocument;->toGenericDocument(Lcom/samsung/android/sdk/aisuggestion/schema/clip/event/CapturedImminentEventDataDocument;)Lh/z;
