.class public final Lcom/samsung/android/sdk/aisuggestion/schema/knox/$$__AppSearch__KnoxComplianceDataDocument;
...
# static fields
.field public static final SCHEMA_NAME:Ljava/lang/String; = "ContextualInsightData:KnoxCompliance"
...
# virtual methods
.method public fromGenericDocument(Lh/z;Ljava/util/Map;)Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;
    .locals 19
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 20
    :goto_4
    const-string v2, "complianceScore"
    ...
    .line 23
    :goto_5
    const-string v2, "complianceScoreValue"
    ...
    .line 27
    :goto_6
    const-string v2, "complianceTitle"
    ...
    .line 33
    :goto_8
    new-instance v5, Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;
    ...
    invoke-direct/range {v2 .. v12}, Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public bridge synthetic fromGenericDocument(Lh/z;Ljava/util/Map;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/sdk/aisuggestion/schema/knox/$$__AppSearch__KnoxComplianceDataDocument;->fromGenericDocument(Lh/z;Ljava/util/Map;)Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;
...
.method public getSchema()Lh/u;
    ...
    const-string p0, "ContextualInsightData:KnoxCompliance"
    ...
    const-string v3, "complianceScore"
    ...
    const-string v3, "complianceScoreValue"
    ...
    const-string v3, "complianceTitle"

    invoke-static {p0, v0, v3, v1, v2}, Lf1/d;->i(Lh/h;Lh/t;Ljava/lang/String;II)Lh/s;

    move-result-object v0

    const-string v3, "complianceDescription"
...
.method public toGenericDocument(Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;)Lh/z;
    .locals 5
    ...
    const-string v2, "ContextualInsightData:KnoxCompliance"
    ...
    .line 15
    :cond_4
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;->getComplianceScore()Ljava/lang/String;
    ...
    .line 16
    const-string v1, "complianceScore"
    ...
    .line 17
    :cond_5
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;->getComplianceScoreValue()J
    ...
    const-string v0, "complianceScoreValue"

    invoke-virtual {p0, v0, v2}, Lh/z$a;->f(Ljava/lang/String;[J)Lh/z$a;

    .line 18
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;->getBackgroundColor()Ljava/lang/String;
    ...
    .line 20
    :cond_6
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;->getComplianceTitle()Ljava/lang/String;
    ...
    .line 22
    :cond_7
    invoke-virtual {p1}, Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;->getComplianceDescription()Ljava/lang/String;
...
.method public bridge synthetic toGenericDocument(Ljava/lang/Object;)Lh/z;
    ...
    .line 1
    check-cast p1, Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;

    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/aisuggestion/schema/knox/$$__AppSearch__KnoxComplianceDataDocument;->toGenericDocument(Lcom/samsung/android/sdk/aisuggestion/schema/knox/KnoxComplianceDataDocument;)Lh/z;
