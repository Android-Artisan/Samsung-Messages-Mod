.class public Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;
...
.method public constructor <init>()V
    ...
    .line 2
    iput v0, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->x1:F

    .line 3
    iput v0, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->x2:F

    .line 4
    iput v0, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->y1:F

    .line 5
    iput v0, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->y2:F
...
.method public constructor <init>(Lcom/samsung/android/spr/drawable/document/SprInputStream;)V
    ...
    .line 11
    invoke-virtual {p0, p1}, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->fromSPR(Lcom/samsung/android/spr/drawable/document/SprInputStream;)V
...
.method public draw(Lcom/samsung/android/spr/drawable/document/SprDocument;Landroid/graphics/Canvas;FFF)V
    ...
    iget v1, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->x1:F

    iget v2, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->y1:F

    iget v3, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->x2:F

    iget v4, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->y2:F

    iget-object v5, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectBase;->strokePaint:Landroid/graphics/Paint;
...
.method public toSPR(Ljava/io/DataOutputStream;)V
    ...
    iget v0, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->x1:F

    invoke-virtual {p1, v0}, Ljava/io/DataOutputStream;->writeFloat(F)V

    iget v0, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->y1:F

    invoke-virtual {p1, v0}, Ljava/io/DataOutputStream;->writeFloat(F)V

    iget v0, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->x2:F

    invoke-virtual {p1, v0}, Ljava/io/DataOutputStream;->writeFloat(F)V

    iget v0, p0, Lcom/samsung/android/spr/drawable/document/shape/SprObjectShapeLine;->y2:F
