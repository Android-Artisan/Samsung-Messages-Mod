...
.method public static a(Landroid/content/Context;Ljava/util/List;)Landroid/database/Cursor;
    .locals 6
    ...
    const-string p0, "ORC/DefaultShortcutLoader"

    const-string p1, "getPinnedShortcutCursor: empty container"
    ...
    const-string/jumbo v1, "shortcut_id IN ("
...
.method public static b(Landroid/content/Context;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    const-string v0, "ORC/DefaultShortcutLoader"
    ...
    :cond_0
    :try_start_0
    invoke-static {p0, p1}, LJb/b;->a(Landroid/content/Context;Ljava/util/List;)Landroid/database/Cursor;
    ...
    :try_start_1
    const-string p0, "loadEntryList: null cursor"
    ...
    invoke-direct {v2, p0}, LJb/n;-><init>(Landroid/content/Context;)V

    invoke-virtual {v2, p1}, LJb/n;->x(Landroid/database/Cursor;)J

    invoke-virtual {v2}, LJb/n;->y()V

    new-instance v3, LJb/j;

    invoke-direct {v3}, LJb/j;-><init>()V

    invoke-virtual {v3, p0, v2}, LJb/j;->a(Landroid/content/Context;LJb/n;)Landroid/content/pm/ShortcutInfo$Builder;
