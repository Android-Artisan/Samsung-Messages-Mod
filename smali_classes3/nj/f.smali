...
.method public final b(Ljava/util/ArrayList;)Landroid/os/Bundle;
    ...
    iget-object v3, p0, Lnj/f;->b:Ljava/lang/String;
...
.method public final call(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    const-string/jumbo v0, "service_registration"
    ...
    iget-object p1, p0, Lnj/f;->a:Landroid/os/Bundle;
    ...
    :goto_1
    iget-object v0, p0, Lnj/f;->a:Landroid/os/Bundle;
    ...
    iget-object p0, p0, Lnj/f;->a:Landroid/os/Bundle;
    ...
    invoke-static {p2, p1}, Lnj/f;->a(Ljava/lang/String;Z)Landroid/os/Bundle;
    ...
    :catch_0
    :cond_3
    invoke-virtual {p0, p1}, Lnj/f;->b(Ljava/util/ArrayList;)Landroid/os/Bundle;
    ...
    iget-object v3, p0, Lnj/f;->a:Landroid/os/Bundle;
...
.method public onCreate()Z
    ...
    iput-object v3, p0, Lnj/f;->b:Ljava/lang/String;

    new-instance v4, Landroid/os/Bundle;

    invoke-direct {v4}, Landroid/os/Bundle;-><init>()V

    iput-object v4, p0, Lnj/f;->a:Landroid/os/Bundle;
    ...
    iget-object v4, p0, Lnj/f;->a:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lnj/f;->a:Landroid/os/Bundle;

    const-string/jumbo v2, "registered"

    const/4 v4, 0x0

    invoke-static {v2, v4}, Lnj/f;->a(Ljava/lang/String;Z)Landroid/os/Bundle;
    ...
    const-string/jumbo v2, "pushRegistered"
    ...
    const-string/jumbo v2, "supportPush"
    ...
    const-string/jumbo v7, "serviceClientVer"

    invoke-static {v5}, Ljj/a;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lnj/f;->b(Ljava/util/ArrayList;)Landroid/os/Bundle;
    ...
    const-string/jumbo v1, "plainLogList"
...
.method public final openFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    iget-object p2, p0, Lnj/f;->a:Landroid/os/Bundle;
