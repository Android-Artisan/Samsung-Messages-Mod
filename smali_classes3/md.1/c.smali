...
.method public static h(Landroid/database/Cursor;[Ljava/lang/String;Ljava/io/OutputStreamWriter;)V
    .locals 5
    ...
    const-string v2, " textTemplates length : "
    ...
    const-string v2, "ORC/QuickResponseBnR"
...
.method public final a()V
    ...
    iget-object v0, p0, Lmd/c;->d:Ljava/io/File;
    ...
    const-string p0, "ORC/QuickResponseBnR"

    const-string v0, "Decrypted Quick Responses file not deleted"
...
.method public final b()V
    ...
    iget-object v0, p0, Lmd/c;->c:Ljava/io/File;
    ...
    iget-object p0, p0, Lmd/c;->c:Ljava/io/File;
    ...
    const-string v0, "Encrypted Quick responses file not deleted"
...
.method public final c()V
    ...
    iget-object v0, p0, Lmd/c;->e:Ljava/io/File;
    ...
    iget-object p0, p0, Lmd/c;->e:Ljava/io/File;
    ...
    const-string v0, "Decrypted Quick response file not deleted"
...
.method public final d()V
    ...
    const-string v2, "getBackupQuickResponses"

    const-string v3, "/com.android.mms_quickresponses.txt"

    const-string v4, "getBackupQuickResponses()"

    const-string v5, "ORC/QuickResponseBnR"
    ...
    :try_start_0
    sget-object v7, Lcom/samsung/android/messaging/common/provider/WithAppContract;->URI_QUICK_RESPONSES:Landroid/net/Uri;

    iget-object v6, p0, Lmd/c;->a:Landroid/content/Context;
    ...
    invoke-static {v0}, Lcom/samsung/android/messaging/common/provider/WithAppContract;->getTextTemplates(Landroid/content/Context;)[Ljava/lang/String;
    ...
    invoke-virtual {v3, v7}, Ljava/io/OutputStreamWriter;->append(Ljava/lang/CharSequence;)Ljava/io/Writer;
    ...
    invoke-static {v6, v0, v3}, Lmd/c;->h(Landroid/database/Cursor;[Ljava/lang/String;Ljava/io/OutputStreamWriter;)V
    :try_end_3
    ...
    :cond_1
    :goto_2
    const-string v0, "No quickResponses"
    ...
    :cond_3
    :goto_7
    iput-object v4, p0, Lmd/c;->d:Ljava/io/File;
...
.method public final e(I)V
    ...
    iget-object v1, p0, Lmd/c;->b:Ljava/lang/String;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v2, "/encrypt_quick_responses.txt"
    ...
    iput-object v0, p0, Lmd/c;->c:Ljava/io/File;
    ...
    const-string v1, "/com.android.mms_quickresponses.txt"
    ...
    iput-object p1, p0, Lmd/c;->e:Ljava/io/File;
...
.method public final f(I)V
    ...
    iget-object v2, p0, Lmd/c;->b:Ljava/lang/String;
    ...
    iput-object p1, p0, Lmd/c;->c:Ljava/io/File;
...
.method public final g()V
    ...
    iput-object v0, p0, Lmd/c;->e:Ljava/io/File;
...
.method public final i()V
    ...
    iget-object p0, p0, Lmd/c;->a:Landroid/content/Context;
    ...
    :goto_0
    sget-object v4, Lcom/samsung/android/messaging/common/provider/WithAppContract;->URI_QUICK_RESPONSES:Landroid/net/Uri;
    ...
    :cond_1
    sget-object v5, Lcom/samsung/android/messaging/common/provider/WithAppContract;->URI_QUICK_RESPONSES:Landroid/net/Uri;

    invoke-static {p0, v5, v7}, Lcom/samsung/android/messaging/common/wrapper/SqliteWrapper;->insert(Landroid/content/Context;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
