...
.method public constructor <init>(JLjava/lang/String;JZI)V
    ...
    const-string/jumbo p2, "revoke_user_select"

    invoke-virtual {p1, p2, p6}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V

    iget-object p1, p0, LO8/P;->a:Landroid/os/Bundle;

    const-string/jumbo p2, "revoke_msg_type"

    invoke-virtual {p1, p2, p7}, Landroid/os/BaseBundle;->putInt(Ljava/lang/String;I)V
