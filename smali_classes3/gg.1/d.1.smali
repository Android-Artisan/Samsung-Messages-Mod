...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lxb/b;LBb/a;Lag/L;Lje/n;)V
    .locals 1
    ...
    iput-object v0, p0, Lgg/d;->d:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lgg/d;->e:Ljava/util/HashMap;

    iput-object p1, p0, Lgg/d;->a:Landroid/content/Context;

    iput-object p2, p0, Lgg/d;->b:Lxb/b;

    iput-object p3, p0, Lgg/d;->c:LBb/a;

    iput-object p4, p0, Lgg/d;->f:Lag/L;

    iput-object p5, p0, Lgg/d;->g:Lje/n;
...
# virtual methods
.method public final a(Lcom/samsung/android/messaging/ui/view/widget/avatar/AvatarGroupBadge;)Landroid/graphics/drawable/Drawable;
    .locals 3
    ...
    const-string v2, "avatar getDrawable = "
    ...
    const-string v2, "ORC/SearchChipsHelper"
