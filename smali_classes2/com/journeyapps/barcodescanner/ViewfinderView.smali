...
.field public o:LM3/g;

.field public p:Landroid/graphics/Rect;

.field public q:LM3/u;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v2, Ln3/l;->zxing_finder:[I

    invoke-virtual {v1, p2, v2}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p2

    sget v1, Ln3/l;->zxing_finder_zxing_viewfinder_mask:I

    sget v2, Ln3/g;->zxing_viewfinder_mask:I
    ...
    sget v1, Ln3/l;->zxing_finder_zxing_result_view:I

    sget v2, Ln3/g;->zxing_result_view:I
    ...
    sget v1, Ln3/l;->zxing_finder_zxing_viewfinder_laser:I

    sget v2, Ln3/g;->zxing_viewfinder_laser:I
    ...
    sget v1, Ln3/l;->zxing_finder_zxing_possible_result_points:I

    sget v2, Ln3/g;->zxing_possible_result_points:I
    ...
    sget p1, Ln3/l;->zxing_finder_zxing_viewfinder_laser_visibility:I
    ...
    iput-object p1, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->m:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1, p2}, Ljava/util/ArrayList;-><init>(I)V

    iput-object p1, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->n:Ljava/util/ArrayList;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->p:Landroid/graphics/Rect;

    if-eqz v0, :cond_8

    iget-object v1, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->q:LM3/u;
    ...
    iget-boolean v2, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->j:Z
    ...
    sget-object v2, Lcom/journeyapps/barcodescanner/ViewfinderView;->r:[I

    iget v3, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->l:I
    ...
    iput v2, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->l:I
    ...
    iget-object v1, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->n:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->isEmpty()Z

    move-result v1

    iget v4, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->i:I
    ...
    :cond_5
    iget-object v1, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->m:Ljava/util/ArrayList;
    ...
    :cond_6
    iget-object p1, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->m:Ljava/util/ArrayList;

    iget-object v1, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->n:Ljava/util/ArrayList;

    iput-object v1, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->m:Ljava/util/ArrayList;
...
.method public setCameraPreview(LM3/g;)V
    .locals 2

    iput-object p1, p0, Lcom/journeyapps/barcodescanner/ViewfinderView;->o:LM3/g;
    ...
    iget-object p0, p1, LM3/g;->p:Ljava/util/ArrayList;
