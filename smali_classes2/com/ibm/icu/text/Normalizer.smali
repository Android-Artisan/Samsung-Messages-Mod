...
.method public static cmpEquivFold(Ljava/lang/CharSequence;Ljava/lang/CharSequence;I)I
    .locals 28
    ...
    iget-object v12, v8, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;->cs:Ljava/lang/CharSequence;

    if-eqz v12, :cond_2

    iget v14, v8, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;->s:I
    ...
    iget-object v13, v9, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;->cs:Ljava/lang/CharSequence;

    if-eqz v13, :cond_5

    iget v15, v9, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;->s:I
    ...
    invoke-virtual {v5, v12, v6, v0}, Lcom/ibm/icu/impl/UCaseProps;->toFullFolding(ILjava/lang/StringBuffer;I)I
    ...
    iput v10, v3, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;->s:I
    ...
    invoke-virtual {v6, v1, v3}, Ljava/lang/StringBuffer;->delete(II)Ljava/lang/StringBuffer;
    ...
    invoke-virtual {v6, v15}, Ljava/lang/StringBuffer;->appendCodePoint(I)Ljava/lang/StringBuffer;
    ...
    invoke-virtual {v5, v13, v7, v0}, Lcom/ibm/icu/impl/UCaseProps;->toFullFolding(ILjava/lang/StringBuffer;I)I
    ...
    iput-object v9, v11, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;->cs:Ljava/lang/CharSequence;

    iput v1, v11, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;->s:I
    ...
    invoke-virtual {v7, v3, v1}, Ljava/lang/StringBuffer;->delete(II)Ljava/lang/StringBuffer;
    ...
    invoke-virtual {v7, v4}, Ljava/lang/StringBuffer;->appendCodePoint(I)Ljava/lang/StringBuffer;
    ...
    iput v10, v1, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;->s:I
    ...
    iput-object v3, v1, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;->cs:Ljava/lang/CharSequence;
...
.method private static final createCmpEquivLevelStack()[Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;
    ...
    new-instance v0, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;-><init>(Lcom/ibm/icu/text/Normalizer$1;)V

    new-instance v2, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;

    invoke-direct {v2, v1}, Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;-><init>(Lcom/ibm/icu/text/Normalizer$1;)V

    filled-new-array {v0, v2}, [Lcom/ibm/icu/text/Normalizer$CmpEquivLevel;
...
.method public static getFC_NFKC_Closure(I)Ljava/lang/String;
    ...
    .line 8
    invoke-virtual {v1, p0, v2, v3}, Lcom/ibm/icu/impl/UCaseProps;->toFullFolding(ILjava/lang/StringBuffer;I)I
    ...
    .line 12
    :cond_0
    invoke-virtual {v2, p0}, Ljava/lang/StringBuffer;->appendCodePoint(I)Ljava/lang/StringBuffer;
...
.method private nextNormalize()Z
    ...
    iget-object p0, p0, Lcom/ibm/icu/text/Normalizer;->buffer:Ljava/lang/StringBuilder;
...
.method public static normalize(ILcom/ibm/icu/text/Normalizer$Mode;I)Ljava/lang/String;
    ...
    invoke-virtual {p1, p0}, Lcom/ibm/icu/impl/Normalizer2Impl;->getDecomposition(I)Ljava/lang/String;
...
.method public clone()Ljava/lang/Object;
    ...
    iget p0, p0, Lcom/ibm/icu/text/Normalizer;->nextIndex:I

    iput p0, v0, Lcom/ibm/icu/text/Normalizer;->nextIndex:I
    :try_end_0
    .catch Ljava/lang/CloneNotSupportedException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public current()I
    ...
    iget p0, p0, Lcom/ibm/icu/text/Normalizer;->bufferPos:I
...
.method public endIndex()I
    ...
    iget-object p0, p0, Lcom/ibm/icu/text/Normalizer;->text:Lcom/ibm/icu/text/UCharacterIterator;
...
.method public getIndex()I
    ...
    iget p0, p0, Lcom/ibm/icu/text/Normalizer;->currentIndex:I
...
.method public getMode()Lcom/ibm/icu/text/Normalizer$Mode;
    ...
    iget-object p0, p0, Lcom/ibm/icu/text/Normalizer;->mode:Lcom/ibm/icu/text/Normalizer$Mode;
...
.method public getOption(I)I
    ...
    iget p0, p0, Lcom/ibm/icu/text/Normalizer;->options:I
...
.method public getText([C)I
    ...
    invoke-virtual {p0, p1}, Lcom/ibm/icu/text/UCharacterIterator;->getText([C)I
...
.method public setText(Lcom/ibm/icu/text/UCharacterIterator;)V
    ...
    const-string p1, "Could not clone the UCharacterIterator"
