...
.method public static synthetic access$000(D)Ljava/lang/String;
    .locals 0
...
.method public static synthetic access$100(D)Ljava/lang/String;
    .locals 0
...
.method private eclipticObliquity()D
    ...
    const-wide v2, 0x3f8aa1edb45c4be9L    # 0.013004166666666666
...
.method private getSiderealOffset()D
    ...
    const-wide v4, 0x401aca1c8e5eb098L    # 6.697374558

    add-double/2addr v2, v4

    const-wide v4, 0x3efb1e471b7b0e47L    # 2.5862E-5
...
.method private static radToDms(D)Ljava/lang/String;
    ...
    invoke-static {v0, p0, p1}, Lcom/samsung/android/messaging/common/cmstore/a;->h(Ljava/lang/String;ILjava/lang/StringBuilder;)Ljava/lang/String;
...
.method public getMoonPosition()Lcom/ibm/icu/impl/CalendarAstronomer$Equatorial;
    ...
    const-wide v13, 0x3f96c471a926a187L    # 0.022233749341155764
    ...
    const-wide v15, 0x3f6a90b0aba4fc89L    # 0.003242821750205464

    mul-double/2addr v13, v15

    iget-wide v11, v0, Lcom/ibm/icu/impl/CalendarAstronomer;->meanAnomalySun:D

    invoke-static {v11, v12}, Ljava/lang/Math;->sin(D)D

    move-result-wide v11

    const-wide v17, 0x3f7a736889d66dd0L    # 0.00645771823237902
    ...
    const-wide v7, 0x3fbc1905209a88deL    # 0.10975677534091541
    ...
    const-wide v17, 0x3f6e98df535623b2L    # 0.0037350045992678655
    ...
    const-wide v5, 0x3f8787ceeab4c1caL    # 0.011489502465878671
    ...
    const-wide v1, 0x3f4e48eb230f0fe5L    # 9.242199067718253E-4
    ...
    const-wide v5, 0x3f66e05a695f8191L    # 0.0027925268031909274
...
.method public getSunLongitude(D)[D
    ...
    const-wide v2, 0x3f911d3671ac14c6L    # 0.016713

    .line 8
    invoke-direct {p0, p1, p2, v2, v3}, Lcom/ibm/icu/impl/CalendarAstronomer;->trueAnomaly(DD)D
