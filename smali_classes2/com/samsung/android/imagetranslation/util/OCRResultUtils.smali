...
.method public static convertOCRResult(Lcom/samsung/android/sdk/ocr/OCRResult;)V
    ...
    const-string/jumbo v15, "o blockPoint : "
    ...
    invoke-static {v3}, Lcom/samsung/android/imagetranslation/util/OCRResultUtils;->getWidthDistance([Landroid/graphics/Point;)I
    ...
    invoke-static {v3}, Lcom/samsung/android/imagetranslation/util/OCRResultUtils;->getHeightDistance([Landroid/graphics/Point;)I
    ...
    invoke-static {v1, v3}, Lcom/samsung/android/imagetranslation/common/LTTLogger;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static/range {v22 .. v22}, Lcom/samsung/android/imagetranslation/util/OCRResultUtils;->getWidthDistance([Landroid/graphics/Point;)I
    ...
    invoke-static/range {v23 .. v23}, Lcom/samsung/android/imagetranslation/util/OCRResultUtils;->getHeightDistance([Landroid/graphics/Point;)I
    ...
    invoke-static {v8}, Lcom/samsung/android/imagetranslation/util/OCRResultUtils;->getHeightDistance([Landroid/graphics/Point;)I
    ...
    invoke-static {v5}, Lcom/samsung/android/imagetranslation/util/OCRResultUtils;->getWidthDistance([Landroid/graphics/Point;)I
    ...
    invoke-static {v5}, Lcom/samsung/android/imagetranslation/util/OCRResultUtils;->getHeightDistance([Landroid/graphics/Point;)I
    ...
    invoke-static {v1, v4}, Lcom/samsung/android/imagetranslation/common/LTTLogger;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v0}, Lcom/samsung/android/imagetranslation/common/LTTLogger;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "newBlock a["
    ...
    invoke-static {v7}, Lcom/samsung/android/imagetranslation/util/OCRResultUtils;->getOrientationWithPoly([Landroid/graphics/Point;)D
    ...
    invoke-static {v8}, Lcom/samsung/android/imagetranslation/util/OCRResultUtils;->getWidthDistance([Landroid/graphics/Point;)I
    ...
    const-string/jumbo v2, "newBlock : "
