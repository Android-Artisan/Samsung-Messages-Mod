.class public Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderTravelTrain;
...
.method public getInsertContentValues()Landroid/content/ContentValues;
    ...
    iget-object v2, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderTravelBase;->mExtractedSeatNo:Ljava/lang/String;

    invoke-static {v0, v1, v2}, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardBase;->putInContentValues(Landroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "SeatConfirmation"

    iget-object p0, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderTravelBase;->mExtractedSeatConfirmation:Ljava/lang/String;
...
.method public getReturnTravelInsertContentValues()Landroid/content/ContentValues;
    ...
    iget-object v2, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderTravelBase;->mExtractedReturnTravelCommuteNumber:Ljava/lang/String;
...
.method public getReturnTravelUpdateContentValues()Landroid/content/ContentValues;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderTravelTrain;->getReturnTravelInsertContentValues()Landroid/content/ContentValues;
...
.method public getUpdateContentValues()Landroid/content/ContentValues;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderTravelTrain;->getInsertContentValues()Landroid/content/ContentValues;
...
.method public injectData(JLjava/lang/String;Ljava/lang/String;JILjava/lang/String;Ljava/util/HashMap;)V
    ...
    const-string/jumbo p1, "trainname"
    ...
    const-string/jumbo p1, "seatconfirmation"

    invoke-virtual {p0, p9, p1, p2}, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardBase;->get(Ljava/util/HashMap;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderTravelBase;->mExtractedSeatConfirmation:Ljava/lang/String;
...
.method public queryExistingMsgId()J
    ...
    const-string v0, "TravelUniqueId"
    ...
    iget-object v1, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderTravelBase;->mExtractedTravelUniqueID:Ljava/lang/String;
...
.method public queryExistingMsgIdReturnTravel()J
    ...
    iget-object v1, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderTravelBase;->mExtractedReturnTravelUniqueID:Ljava/lang/String;
