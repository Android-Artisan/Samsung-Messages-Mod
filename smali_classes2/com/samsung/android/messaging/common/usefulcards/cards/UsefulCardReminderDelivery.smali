.class public Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderDelivery;
.super Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderBase;
.source "SourceFile"


# static fields
.field private static final TAG:Ljava/lang/String; = "UCP/UsefulCardReminderDelivery"


# instance fields
.field protected mExtractedPin:Ljava/lang/String;

.field protected mExtractedProductName:Ljava/lang/String;
...
.method public areCriticalFieldsMissing()Z
    ...
    iget-object v0, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderDelivery;->mExtractedProductName:Ljava/lang/String;
    ...
    const-string v3, "UCP/UsefulCardReminderDelivery"
...
.method public getInsertContentValues()Landroid/content/ContentValues;
    ...
    const-string v1, "delivery_ProductName"

    iget-object v2, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderDelivery;->mExtractedProductName:Ljava/lang/String;
    ...
    const-string v1, "delivery_PIN"

    iget-object v2, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderDelivery;->mExtractedPin:Ljava/lang/String;

    invoke-static {v0, v1, v2}, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardBase;->putInContentValues(Landroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "delivery_PhoneNumber"
...
.method public getUpdateContentValues()Landroid/content/ContentValues;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderDelivery;->getInsertContentValues()Landroid/content/ContentValues;
...
.method public injectData(JLjava/lang/String;Ljava/lang/String;JILjava/lang/String;Ljava/util/HashMap;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderDelivery;->mExtractedPin:Ljava/lang/String;

    const-string p1, "delitem"

    invoke-virtual {p0, p9, p1, p2}, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardBase;->get(Ljava/util/HashMap;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderDelivery;->mExtractedProductName:Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderDelivery;->setCardValidity()V
...
.method public insert(Landroid/content/Context;)Landroid/net/Uri;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardReminderDelivery;->areCriticalFieldsMissing()Z
    ...
    const-string v4, "UCP/UsefulCardReminderDelivery"
    ...
    const-string v0, ", Card validity expired, Delivery date : "
    ...
    :cond_1
    iget-wide v5, p0, Lcom/samsung/android/messaging/common/usefulcards/cards/UsefulCardBase;->mExtractedCardValidity:J

    invoke-static {v5, v6}, Lcom/samsung/android/messaging/common/usefulcards/UsefulCardDbUtils;->isToday(J)Z
    ...
    const-string v0, ", Delivery is not today. Delivery date : "
    ...
    invoke-static {v2, v5}, Lcom/samsung/android/messaging/common/usefulcards/UsefulCardDbUtils;->doSaLoggingForCard(ILjava/lang/String;)V
    ...
    const-string v3, ", New card created."

    invoke-static {v5, v6, v3, v4, v2}, Lcom/samsung/android/messaging/common/cmstore/a;->s(JLjava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V
