.class public Lcom/samsung/android/messaging/common/util/encoding/CharacterSets;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/samsung/android/messaging/common/util/encoding/CharacterSets;->MIBENUM_NUMBERS:[I

    const-string/jumbo v17, "utf-16"

    const-string v18, "EUC_KR"
    ...
    const-string/jumbo v13, "shift_JIS"
    ...
    sput-object v2, Lcom/samsung/android/messaging/common/util/encoding/CharacterSets;->MIME_NAMES:[Ljava/lang/String;

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    sput-object v2, Lcom/samsung/android/messaging/common/util/encoding/CharacterSets;->MIBENUM_TO_NAME_MAP:Ljava/util/HashMap;

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    sput-object v2, Lcom/samsung/android/messaging/common/util/encoding/CharacterSets;->NAME_TO_MIBENUM_MAP:Ljava/util/HashMap;
    ...
    sget-object v2, Lcom/samsung/android/messaging/common/util/encoding/CharacterSets;->MIBENUM_TO_NAME_MAP:Ljava/util/HashMap;

    sget-object v3, Lcom/samsung/android/messaging/common/util/encoding/CharacterSets;->MIBENUM_NUMBERS:[I
    ...
    sget-object v5, Lcom/samsung/android/messaging/common/util/encoding/CharacterSets;->MIME_NAMES:[Ljava/lang/String;

    aget-object v6, v5, v1

    invoke-virtual {v2, v4, v6}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v2, Lcom/samsung/android/messaging/common/util/encoding/CharacterSets;->NAME_TO_MIBENUM_MAP:Ljava/util/HashMap;
...
.method public static getMibEnumValue(Ljava/lang/String;)I
    ...
    :cond_0
    sget-object v0, Lcom/samsung/android/messaging/common/util/encoding/CharacterSets;->NAME_TO_MIBENUM_MAP:Ljava/util/HashMap;
...
.method public static getMimeName(I)Ljava/lang/String;
    ...
    sget-object v0, Lcom/samsung/android/messaging/common/util/encoding/CharacterSets;->MIBENUM_TO_NAME_MAP:Ljava/util/HashMap;
