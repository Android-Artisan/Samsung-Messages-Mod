.class public Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;
...
.field public static final CONVERSATION_TYPE:Ljava/lang/String; = "conv_type"

.field public static final CREATE_INDEX_SQL:Ljava/lang/String; = "CREATE INDEX IF NOT EXISTS index_conversation_recipients_conversation_id_recipient_id ON conversation_recipients(conversation_id, recipient_id);"
...
.field public static final TABLE:Ljava/lang/String; = "conversation_recipients"

.field private static sInstance:Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;->getInstance()Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;
    ...
    sput-object v0, Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;->CREATE_SQL:Ljava/lang/String;
    ...
    sput-object v0, Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;->FIELDS:Ljava/util/List;
...
.method private static getInstance()Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;
    .locals 1

    sget-object v0, Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;->sInstance:Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;

    if-nez v0, :cond_0

    new-instance v0, Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;

    invoke-direct {v0}, Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;-><init>()V

    sput-object v0, Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;->sInstance:Lcom/samsung/android/messaging/common/provider/MessageContentContractConversationRecipients;
