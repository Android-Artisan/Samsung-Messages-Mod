.class Lcom/samsung/android/dialtacts/model/ims/capability/CapabilityAttModel;
.super Lcom/samsung/android/dialtacts/model/ims/capability/CapabilityCommonMultiSimModel;
.source "SourceFile"


# static fields
.field private static final TAG:Ljava/lang/String; = "CM/CapabilityAttModel"
...
.method public constructor <init>(Landroid/content/Context;Lcom/samsung/android/dialtacts/model/ims/imsmanager/ImsModelInterface;Lcom/samsung/android/dialtacts/model/ims/capability/CapabilityModelInterface$CapabilityChangedListener;LJ5/g;)V
    ...
    iput-object p4, p0, Lcom/samsung/android/dialtacts/model/ims/capability/CapabilityAttModel;->mCapabilityDataSource:LJ5/g;

    iput-object p2, p0, Lcom/samsung/android/dialtacts/model/ims/capability/CapabilityAttModel;->mImsModel:Lcom/samsung/android/dialtacts/model/ims/imsmanager/ImsModelInterface;
...
.method public checkCapability(Ljava/lang/String;I[JI)[I
    ...
    const-string v1, "CM/CapabilityAttModel"
    ...
    const-string/jumbo p4, "normalized number : "

    invoke-static {p4, p1, v1}, LL2/e;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object p4, p0, Lcom/samsung/android/dialtacts/model/ims/capability/CapabilityAttModel;->mCapabilityDataSource:LJ5/g;

    const/4 v3, 0x5

    check-cast p4, LJ5/f;

    invoke-virtual {p4, p2, p1, v3}, LJ5/f;->c(Lcom/sec/ims/options/CapabilityManager;Ljava/lang/String;I)Lcom/sec/ims/options/Capabilities;
