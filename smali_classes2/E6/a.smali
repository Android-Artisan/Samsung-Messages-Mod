...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "ORC/BubbleButtonDoAction"
    ...
    const-string/jumbo p1, "organizer"

    const-string p2, "SMS Classification"

    invoke-virtual {v2, p1, p2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    invoke-static {p0, v2}, LE6/a;->g(Landroid/content/Context;Landroid/content/Intent;)V
    :try_end_0
...
.method public static b(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    const-string v2, "   launcherActivityName:"
    ...
    const-string v2, "ORC/BubbleButtonDoAction"
    ...
    invoke-static {v0, p1, p2}, LF6/c;->e0(ILjava/lang/String;Lorg/json/JSONObject;)V

    goto :goto_1

    :cond_3
    invoke-static {p1}, Lcom/samsung/android/messaging/extension/chn/announcement/cardsmssdk/popu/util/IntentUtil;->getIntentOfSamsungAppsByPackageName(Ljava/lang/String;)Landroid/content/Intent;
    ...
    :goto_1
    invoke-static {p0, v1}, LE6/a;->g(Landroid/content/Context;Landroid/content/Intent;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static c(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "openBrowser  url:"
    ...
    invoke-static {p0, v0}, LE6/a;->g(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public static d(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "openWebView: url: "
    ...
    invoke-static {v3}, Lcom/samsung/android/messaging/common/util/JsonUtils;->getNameList(Lorg/json/JSONObject;)Ljava/util/ArrayList;
    ...
    invoke-direct {v5, v4, v6}, Landroidx/core/util/Pair;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :cond_3
    const-string/jumbo v1, "post_parameters_bundle"
...
.method public static f(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "ORC/SendSmsAction"
    ...
    invoke-virtual/range {v0 .. v5}, LE6/f;->d(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_3
    const-string v0, " single sim index = "

    invoke-static {v2, v0, v3}, LL2/e;->z(ILjava/lang/String;Ljava/lang/String;)V

    invoke-static {p0, v2, p1, p2}, LE6/f;->c(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;)V

    goto :goto_1

    :cond_4
    sget p1, LC6/f;->no_sim:I
...
.method public static g(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string p1, "ORC/BubbleButtonDoAction"
...
# virtual methods
.method public abstract e(Landroid/content/Context;Lorg/json/JSONObject;Lorg/json/JSONObject;)V
.end method
