...
.method private applyAnnotations(Lcom/esotericsoftware/kryo/serializers/FieldSerializer$CachedField;)V
    ...
    invoke-direct {p0, v2, v6, v7}, Lcom/esotericsoftware/kryo/serializers/CachedFields;->newSerializer(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)Lcom/esotericsoftware/kryo/Serializer;
    ...
    const-string v1, "@Bind applied to a field that already has a serializer: "
    ...
    const-string v1, "@BindCollection applied to a field that already has a serializer: "
    ...
    invoke-direct {p0, v1, v2, v3}, Lcom/esotericsoftware/kryo/serializers/CachedFields;->newSerializer(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)Lcom/esotericsoftware/kryo/Serializer;
    ...
    invoke-direct {p0, v4, v3, v5}, Lcom/esotericsoftware/kryo/serializers/CachedFields;->newSerializer(Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Class;)Lcom/esotericsoftware/kryo/Serializer;

    move-result-object p0

    new-instance v3, Lcom/esotericsoftware/kryo/serializers/MapSerializer;

    invoke-direct {v3}, Lcom/esotericsoftware/kryo/serializers/MapSerializer;-><init>()V

    invoke-interface {v0}, Lcom/esotericsoftware/kryo/serializers/MapSerializer$BindMap;->keysCanBeNull()Z

    move-result v5

    invoke-virtual {v3, v5}, Lcom/esotericsoftware/kryo/serializers/MapSerializer;->setKeysCanBeNull(Z)V

    invoke-interface {v0}, Lcom/esotericsoftware/kryo/serializers/MapSerializer$BindMap;->valuesCanBeNull()Z

    move-result v0

    invoke-virtual {v3, v0}, Lcom/esotericsoftware/kryo/serializers/MapSerializer;->setValuesCanBeNull(Z)V

    if-eqz v4, :cond_d

    invoke-virtual {v3, v4}, Lcom/esotericsoftware/kryo/serializers/MapSerializer;->setKeyClass(Ljava/lang/Class;)V

    :cond_d
    if-eqz p0, :cond_e

    invoke-virtual {v3, p0}, Lcom/esotericsoftware/kryo/serializers/MapSerializer;->setKeySerializer(Lcom/esotericsoftware/kryo/Serializer;)V

    :cond_e
    if-eqz v1, :cond_f

    invoke-virtual {v3, v1}, Lcom/esotericsoftware/kryo/serializers/MapSerializer;->setValueClass(Ljava/lang/Class;)V

    :cond_f
    if-eqz v2, :cond_10

    invoke-virtual {v3, v2}, Lcom/esotericsoftware/kryo/serializers/MapSerializer;->setValueSerializer(Lcom/esotericsoftware/kryo/Serializer;)V

    :cond_10
    invoke-virtual {p1, v3}, Lcom/esotericsoftware/kryo/serializers/FieldSerializer$CachedField;->setSerializer(Lcom/esotericsoftware/kryo/Serializer;)V
    ...
    const-string v1, "@BindMap applied to a field that already has a serializer: "
