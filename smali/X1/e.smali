...
.method static constructor <clinit>()V
    ...
    sput-object v0, LX1/e;->a:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, LX1/e;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(ILandroid/content/Context;)I
    ...
    sget v1, LX1/g;->common_google_play_services_unknown_issue:I
    ...
    sget-object v0, LX1/e;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    sget-object v0, Lb2/z;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_1
    sget-boolean v2, Lb2/z;->b:Z
    ...
    :cond_1
    sput-boolean v1, Lb2/z;->b:Z

    invoke-virtual {p1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v2

    invoke-static {p1}, Ln2/d;->a(Landroid/content/Context;)Ln2/c;
    ...
    :try_start_2
    iget-object v3, v3, Ln2/c;->a:Landroid/content/Context;
    ...
    sget-object v0, LF/a;->e:Ljava/lang/Boolean;
    ...
    sput-object v0, LF/a;->e:Ljava/lang/Boolean;
    ...
    const-class v8, LX1/f;

    monitor-enter v8

    :try_start_9
    sget-object v9, LX1/f;->a:LX1/f;

    if-nez v9, :cond_a

    sget-object v9, LX1/p;->a:LX1/l;

    const-class v9, LX1/p;
    ...
    :try_start_a
    sget-object v10, LX1/p;->c:Landroid/content/Context;
    ...
    sput-object v10, LX1/p;->c:Landroid/content/Context;
    :try_end_a
    ...
    invoke-direct {v9, p1}, LX1/f;-><init>(Landroid/content/Context;)V

    sput-object v9, LX1/f;->a:LX1/f;
    :try_end_d
    ...
    invoke-static {v7}, LX1/f;->a(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-static {v6}, LX1/f;->a(Landroid/content/pm/PackageInfo;)Z
