...
.method public static d(Landroid/app/Activity;ILb2/r;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/AlertDialog;
    .locals 5
    ...
    :cond_2
    invoke-static {p1, p0}, Lb2/p;->b(ILandroid/content/Context;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p0}, Lb2/p;->c(ILandroid/content/Context;)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p1, p0}, Lb2/p;->a(ILandroid/content/Context;)Ljava/lang/String;
...
.method public static g(Landroid/app/Activity;Landroid/app/AlertDialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    iput-object p1, v2, LX1/h;->a:Landroid/app/AlertDialog;

    if-eqz p3, :cond_0

    iput-object p3, v2, LX1/h;->b:Landroid/content/DialogInterface$OnCancelListener;
...
.method public final c(Lcom/google/android/gms/common/api/GoogleApiActivity;ILcom/google/android/gms/common/api/GoogleApiActivity;)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lb2/q;-><init>(Landroid/content/Intent;Ljava/lang/Object;I)V

    invoke-static {p1, p2, v0, p3}, LX1/b;->d(Landroid/app/Activity;ILb2/r;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/AlertDialog;
    ...
    invoke-static {p1, p0, p2, p3}, LX1/b;->g(Landroid/app/Activity;Landroid/app/AlertDialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V

    return-void
.end method

.method public final e(Landroid/app/Activity;LZ1/h;ILandroid/content/DialogInterface$OnCancelListener;)V
    .locals 2
    ...
    invoke-direct {v0, p0, p2, v1}, Lb2/q;-><init>(Landroid/content/Intent;Ljava/lang/Object;I)V

    invoke-static {p1, p3, v0, p4}, LX1/b;->d(Landroid/app/Activity;ILb2/r;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/AlertDialog;
    ...
    invoke-static {p1, p0, p2, p4}, LX1/b;->g(Landroid/app/Activity;Landroid/app/AlertDialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final f(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {p2, p0, p1}, LX1/i;-><init>(LX1/b;Landroid/content/Context;)V
    ...
    invoke-static {p1, v0}, Lb2/p;->f(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p2, p1}, Lb2/p;->a(ILandroid/content/Context;)Ljava/lang/String;
    ...
    sget v2, LW1/b;->common_google_play_services_notification_ticker:I
    ...
    :cond_5
    invoke-static {p2, p1}, Lb2/p;->b(ILandroid/content/Context;)Ljava/lang/String;
    ...
    :cond_6
    :goto_1
    invoke-static {p1}, Lb2/p;->d(Landroid/content/Context;)Ljava/lang/String;

    move-result-object p0

    const-string v2, "common_google_play_services_resolution_required_text"

    invoke-static {p1, v2, p0}, Lb2/p;->e(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v1}, Landroidx/core/app/NotificationCompat$Builder;->setLocalOnly(Z)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v4, p0}, Landroidx/core/app/NotificationCompat$BigTextStyle;->bigText(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$BigTextStyle;
    ...
    sget-object v5, LF/a;->c:Ljava/lang/Boolean;
    ...
    sput-object v4, LF/a;->c:Ljava/lang/Boolean;

    :cond_7
    sget-object v4, LF/a;->c:Ljava/lang/Boolean;
    ...
    invoke-virtual {p0, v5}, Landroidx/core/app/NotificationCompat$Builder;->setPriority(I)Landroidx/core/app/NotificationCompat$Builder;

    invoke-static {p1}, LF/a;->N(Landroid/content/Context;)Z

    move-result p0

    if-eqz p0, :cond_9

    sget p0, LW1/a;->common_full_open_on_phone:I

    sget v4, LW1/b;->common_open_on_phone:I

    invoke-virtual {v2, v4}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, p0, v2, p3}, Landroidx/core/app/NotificationCompat$Builder;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    sget v6, LW1/b;->common_google_play_services_notification_ticker:I
    ...
    sget v2, LW1/b;->common_google_play_services_notification_channel_name:I
    ...
    :cond_d
    sget-object p1, LX1/e;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
