...
.field private final mRightDragger:LR/h;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 16
    iput-boolean v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mIsShowingCanvasBlur:Z

    .line 17
    iput-boolean v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mIsFloatingDrawerView:Z
    ...
    invoke-direct {v3, p0, v4}, LPc/o0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v5, v6, p0, v4}, LR/h;-><init>(Landroid/content/Context;Landroid/view/ViewGroup;LR/g;)V
    ...
    .line 26
    iput-object v5, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LR/h;
    ...
    .line 29
    invoke-virtual {v4, v5}, Landroidx/drawerlayout/widget/DrawerLayout$ViewDragCallback;->setDragger(LR/h;)V
    ...
    invoke-direct {v4, v5, p0, v1}, LR/h;-><init>(Landroid/content/Context;Landroid/view/ViewGroup;LR/g;)V
    ...
    .line 32
    iput-object v4, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LR/h;
    ...
    .line 35
    invoke-virtual {v1, v4}, Landroidx/drawerlayout/widget/DrawerLayout$ViewDragCallback;->setDragger(LR/h;)V
    ...
    iput-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mStatusBarBackground:Landroid/graphics/drawable/Drawable;
    :try_end_0
    ...
    sget p3, Landroidx/drawerlayout/R$dimen;->sesl_drawer_elevation:I
...
.method public closeDrawer(Landroid/view/View;Z)V
    ...
    .line 7
    invoke-direct {p0}, Landroidx/drawerlayout/widget/DrawerLayout;->shouldSkipScroll()Z
    ...
    .line 10
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LR/h;
    ...
    .line 12
    invoke-virtual {p2, v0, v1, p1}, LR/h;->s(IILandroid/view/View;)Z

    goto :goto_0

    .line 13
    :cond_1
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LR/h;
...
.method public closeDrawers(Z)V
    ...
    .line 9
    iget-object v7, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LR/h;
    ...
    .line 11
    invoke-virtual {v7, v6, v8, v4}, LR/h;->s(IILandroid/view/View;)Z
    ...
    .line 13
    invoke-virtual {p0, v1, v4}, Landroidx/drawerlayout/widget/DrawerLayout;->updateDrawerState(ILandroid/view/View;)V
    ...
    .line 16
    iget-object v6, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LR/h;
    ...
    .line 18
    invoke-virtual {v6, v7, v8, v4}, LR/h;->s(IILandroid/view/View;)Z
...
.method public computeScroll()V
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mIsFloatingDrawerView:Z
    ...
    :cond_2
    iput v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mScrimOpacity:F

    :goto_1
    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LR/h;

    invoke-virtual {v0}, LR/h;->g()Z

    move-result v0

    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LR/h;
...
.method public dispatchOnDrawerSlide(Landroid/view/View;F)V
    ...
    iget-boolean v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mIsShowingCanvasBlur:Z
...
.method public drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v8, v0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LR/h;
    ...
    iget-object v10, v0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LR/h;

    iget v10, v10, LR/h;->o:I
...
.method public moveDrawerToOffset(Landroid/view/View;F)V
    ...
    iget-boolean p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mIsFloatingDrawerView:Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LR/h;

    invoke-virtual {v1, p1}, LR/h;->r(Landroid/view/MotionEvent;)Z

    move-result v1

    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LR/h;

    invoke-virtual {v2, p1}, LR/h;->r(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LR/h;

    iget-object v0, p1, LR/h;->d:[F
    ...
    iget-object v5, p1, LR/h;->f:[F

    aget v5, v5, v4

    iget-object v6, p1, LR/h;->d:[F

    aget v6, v6, v4

    sub-float/2addr v5, v6

    iget-object v6, p1, LR/h;->g:[F

    aget v6, v6, v4

    iget-object v7, p1, LR/h;->e:[F
    ...
    iget-object v4, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LR/h;

    float-to-int v0, v0

    float-to-int p1, p1

    invoke-virtual {v4, v0, p1}, LR/h;->h(II)Landroid/view/View;
...
.method public onLayout(ZIIII)V
    ...
    iget-object v2, v0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LR/h;
    ...
    iget-object v2, v0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LR/h;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, LR/h;->k(Landroid/view/MotionEvent;)V

    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mRightDragger:LR/h;
    ...
    iget-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mLeftDragger:LR/h;

    float-to-int v4, v0

    float-to-int v5, p1

    invoke-virtual {v3, v4, v5}, LR/h;->h(II)Landroid/view/View;
...
.method public openDrawer(Landroid/view/View;Z)V
    ...
    invoke-virtual {p2, v1, v0, p1}, LR/h;->s(IILandroid/view/View;)Z
...
.method public seslSetDrawerViewFloatingBlur(Landroid/content/Context;Landroid/view/View;)V
    .locals 7

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->mIsShowingCanvasBlur:Z

    invoke-direct {p0, p1}, Landroidx/drawerlayout/widget/DrawerLayout;->isLightTheme(Landroid/content/Context;)Z
    ...
    sget v1, Lri/a;->basic_token_gray_white:I
    ...
    invoke-direct {p0, p1, v1}, Landroidx/drawerlayout/widget/DrawerLayout;->getColorWithAlpha(IF)I
...
.method public updateBackInvokedCallbackState()V
    ...
    invoke-direct {v0, p0, v2}, LOc/c;-><init>(Ljava/lang/Object;I)V
