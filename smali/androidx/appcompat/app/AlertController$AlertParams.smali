...
# instance fields
.field public isSingleChoiceOption:Z
...
.field public mSingleChoiceChecked:Z

.field public mSingleChoiceListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;

.field public mSingleChoiceOptionLabel:Ljava/lang/CharSequence;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/app/AlertController$AlertParams;->isSingleChoiceOption:Z

    iput-boolean v0, p0, Landroidx/appcompat/app/AlertController$AlertParams;->mSingleChoiceChecked:Z
...
.method public apply(Landroidx/appcompat/app/AlertController;)V
    ...
    invoke-virtual {p1, v1}, Landroidx/appcompat/app/AlertController;->setCustomTitle(Landroid/view/View;)V
    ...
    invoke-virtual {p1, v1}, Landroidx/appcompat/app/AlertController;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v1}, Landroidx/appcompat/app/AlertController;->setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p1, v1}, Landroidx/appcompat/app/AlertController;->setIcon(I)V
    ...
    invoke-virtual {p1, v1}, Landroidx/appcompat/app/AlertController;->getIconAttributeResId(I)I
    ...
    invoke-virtual {p1, v1}, Landroidx/appcompat/app/AlertController;->setMessage(Ljava/lang/CharSequence;)V

    :cond_5
    iget-object v1, p0, Landroidx/appcompat/app/AlertController$AlertParams;->mSingleChoiceOptionLabel:Ljava/lang/CharSequence;

    if-eqz v1, :cond_6

    iget-object v2, p0, Landroidx/appcompat/app/AlertController$AlertParams;->mMessage:Ljava/lang/CharSequence;

    if-eqz v2, :cond_6

    iget-boolean v2, p0, Landroidx/appcompat/app/AlertController$AlertParams;->mSingleChoiceChecked:Z

    iget-object v3, p0, Landroidx/appcompat/app/AlertController$AlertParams;->mSingleChoiceListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;

    invoke-virtual {p1, v1, v2, v3}, Landroidx/appcompat/app/AlertController;->setSingleChoiceOption(Ljava/lang/CharSequence;ZLandroid/widget/CompoundButton$OnCheckedChangeListener;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/app/AlertController$AlertParams;->mNegativeButtonIcon:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroidx/appcompat/app/AlertController$AlertParams;->mNeutralButtonIcon:Landroid/graphics/drawable/Drawable;
