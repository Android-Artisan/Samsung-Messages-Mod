...
.method private setBlurEffect()Z
    .locals 20
    ...
    :cond_0
    iget-object v3, v0, Landroidx/appcompat/widget/ListPopupWindow;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v3}, Landroidx/appcompat/widget/AppCompatPopupWindow;->seslIsAvailableBlurBackground()Z
    ...
    iget-object v4, v0, Landroidx/appcompat/widget/ListPopupWindow;->mContext:Landroid/content/Context;

    invoke-virtual {v4}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v4

    sget v5, Landroidx/appcompat/R$color;->sesl_popup_menu_blur_background_dark:I

    iget-object v6, v0, Landroidx/appcompat/widget/ListPopupWindow;->mContext:Landroid/content/Context;
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/ListPopupWindow;->mContext:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v4, Landroidx/appcompat/R$dimen;->sesl_menu_popup_corner_radius:I
    ...
    const v10, 0x4356999a    # 214.6f

    const v11, 0x437ccccd    # 252.8f
    ...
    const v18, 0x4212cccd    # 36.7f

    const v19, 0x42af6666    # 87.7f
    ...
    invoke-direct/range {v12 .. v19}, Landroidx/core/view/SemBlurCompat$CurveParameter;-><init>(IFFFFFF)V
    ...
    invoke-static/range {v2 .. v7}, Landroidx/core/view/SemBlurCompat;->setBlurEffectPreset(Landroid/view/View;ILandroidx/core/view/SemBlurCompat$CurveParameter;Ljava/lang/Integer;Ljava/lang/Float;Ljava/lang/Integer;)Z
...
.method private updatePopupHeightForFoldableModel(Landroid/view/View;)I
    ...
    invoke-static {v7, p1, v8}, LU4/l;->s(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v4, p0, v3}, LU4/l;->y(ILjava/lang/String;Ljava/lang/String;)V
...
.method public show()V
    ...
    :goto_9
    invoke-direct {p0}, Landroidx/appcompat/widget/ListPopupWindow;->setBlurEffect()Z
    ...
    invoke-virtual {v2}, Landroidx/appcompat/widget/AppCompatPopupWindow;->seslIsAvailableBlurBackground()Z
    ...
    sget v7, Landroidx/appcompat/R$dimen;->sesl_menu_popup_stroke_width:I
    ...
    sget v8, Landroidx/appcompat/R$color;->sesl_menu_popup_background_stroke_color:I
