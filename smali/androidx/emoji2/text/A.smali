...
.method public constructor <init>(Landroidx/emoji2/text/z;)V
    ...
    iput-object v0, p0, Landroidx/emoji2/text/A;->a:Landroid/graphics/Paint$FontMetricsInt;

    const/4 v0, -0x1

    iput-short v0, p0, Landroidx/emoji2/text/A;->c:S

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Landroidx/emoji2/text/A;->i:F

    const-string v0, "rasterizer cannot be null"

    invoke-static {p1, v0}, Landroidx/core/util/Preconditions;->checkNotNull(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Landroidx/emoji2/text/A;->b:Landroidx/emoji2/text/z;
...
.method public final draw(Landroid/graphics/Canvas;Ljava/lang/CharSequence;IIFIIILandroid/graphics/Paint;)V
    ...
    :cond_0
    iget-object v3, v0, Landroidx/emoji2/text/A;->j:Landroid/text/TextPaint;
    ...
    iput-object v3, v0, Landroidx/emoji2/text/A;->j:Landroid/text/TextPaint;
    ...
    iget-short v1, v0, Landroidx/emoji2/text/A;->c:S
    ...
    :cond_6
    iget-object v0, v0, Landroidx/emoji2/text/A;->b:Landroidx/emoji2/text/z;

    iget-object v1, v0, Landroidx/emoji2/text/z;->b:LDj/u;

    iget-object v3, v1, LDj/u;->i:Ljava/lang/Object;
    ...
    iget v0, v0, Landroidx/emoji2/text/z;->a:I

    mul-int/lit8 v7, v0, 0x2

    const/4 v8, 0x2

    iget-object v0, v1, LDj/u;->b:Ljava/lang/Object;
...
.method public final getSize(Landroid/graphics/Paint;Ljava/lang/CharSequence;IILandroid/graphics/Paint$FontMetricsInt;)I
    ...
    iget-object p2, p0, Landroidx/emoji2/text/A;->a:Landroid/graphics/Paint$FontMetricsInt;
    ...
    iget-object p3, p0, Landroidx/emoji2/text/A;->b:Landroidx/emoji2/text/z;

    invoke-virtual {p3}, Landroidx/emoji2/text/z;->c()LT/a;

    move-result-object p4

    const/16 v0, 0xe

    invoke-virtual {p4, v0}, LT/c;->a(I)I
    ...
    iget-object v3, p4, LT/c;->b:Ljava/nio/ByteBuffer;
    ...
    iput p1, p0, Landroidx/emoji2/text/A;->i:F

    invoke-virtual {p3}, Landroidx/emoji2/text/z;->c()LT/a;

    move-result-object p1

    invoke-virtual {p1, v0}, LT/c;->a(I)I

    move-result p4

    if-eqz p4, :cond_1

    iget-object v0, p1, LT/c;->b:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p1, p3}, LT/c;->a(I)I

    move-result p3

    if-eqz p3, :cond_2

    iget-object p4, p1, LT/c;->b:Ljava/nio/ByteBuffer;
    ...
    iget p3, p0, Landroidx/emoji2/text/A;->i:F
    ...
    iput-short p1, p0, Landroidx/emoji2/text/A;->c:S
