...
# direct methods
.method public constructor <init>(Lcom/airbnb/lottie/u;LX0/b;LW0/n;)V
    .locals 2
    ...
    iput-object v0, p0, LR0/p;->a:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, LR0/p;->b:Landroid/graphics/RectF;

    new-instance v0, LR0/c;

    invoke-direct {v0}, LR0/c;-><init>()V

    iput-object v0, p0, LR0/p;->i:LR0/c;

    const/4 v0, 0x0

    iput-object v0, p0, LR0/p;->j:LS0/d;

    iget-object v0, p3, LW0/n;->a:Ljava/lang/String;

    iput-object v0, p0, LR0/p;->c:Ljava/lang/String;

    iget-boolean v0, p3, LW0/n;->e:Z

    iput-boolean v0, p0, LR0/p;->d:Z

    iput-object p1, p0, LR0/p;->e:Lcom/airbnb/lottie/u;

    iget-object p1, p3, LW0/n;->b:LV0/m;

    invoke-interface {p1}, LV0/m;->a()LS0/d;

    move-result-object p1

    iput-object p1, p0, LR0/p;->f:LS0/d;

    iget-object v0, p3, LW0/n;->c:LV0/m;

    invoke-interface {v0}, LV0/m;->a()LS0/d;

    move-result-object v0

    iput-object v0, p0, LR0/p;->g:LS0/d;

    iget-object p3, p3, LW0/n;->d:LV0/b;
    ...
    iput-object v1, p0, LR0/p;->h:LS0/h;
...
.method public final a()V
    ...
    iput-boolean v0, p0, LR0/p;->k:Z

    iget-object p0, p0, LR0/p;->e:Lcom/airbnb/lottie/u;
...
.method public final c(Ljava/util/List;Ljava/util/List;)V
    ...
    iget-object v2, v1, LR0/u;->c:LW0/x;

    sget-object v3, LW0/x;->a:LW0/x;

    if-ne v2, v3, :cond_0

    iget-object v0, p0, LR0/p;->i:LR0/c;

    iget-object v0, v0, LR0/c;->a:Ljava/util/ArrayList;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v1, p0}, LR0/u;->b(LS0/a;)V

    goto :goto_1

    :cond_0
    instance-of v1, v0, LR0/r;

    if-eqz v1, :cond_1

    check-cast v0, LR0/r;

    iget-object v0, v0, LR0/r;->b:LS0/d;
...
.method public final d(Landroid/graphics/ColorFilter;Lc1/c;)V
    ...
    iget-object p0, p0, LR0/p;->g:LS0/d;
    ...
    iget-object p0, p0, LR0/p;->f:LS0/d;
    ...
    iget-object p0, p0, LR0/p;->h:LS0/h;
...
.method public final h()Landroid/graphics/Path;
    ...
    iget-boolean v1, v0, LR0/p;->k:Z

    iget-object v2, v0, LR0/p;->a:Landroid/graphics/Path;
    ...
    iget-boolean v1, v0, LR0/p;->d:Z

    const/4 v3, 0x1

    if-eqz v1, :cond_1

    iput-boolean v3, v0, LR0/p;->k:Z

    return-object v2

    :cond_1
    iget-object v1, v0, LR0/p;->g:LS0/d;
    ...
    iget-object v6, v0, LR0/p;->h:LS0/h;
    ...
    iget-object v8, v0, LR0/p;->j:LS0/d;

    if-eqz v8, :cond_3

    invoke-virtual {v8}, LS0/d;->f()Ljava/lang/Object;
    ...
    :cond_4
    iget-object v8, v0, LR0/p;->f:LS0/d;
    ...
    iget-object v10, v0, LR0/p;->b:Landroid/graphics/RectF;
    ...
    iget-object v1, v0, LR0/p;->i:LR0/c;

    invoke-virtual {v1, v2}, LR0/c;->a(Landroid/graphics/Path;)V

    const/4 v1, 0x1

    iput-boolean v1, v0, LR0/p;->k:Z
