...
.method public static a(Lcom/google/android/gms/common/internal/GetServiceRequest;Landroid/os/Parcel;I)V
    ...
    invoke-static {p1, v3, v1}, LVm/i;->a0(Landroid/os/Parcel;ILjava/lang/String;)V

    const/4 v1, 0x5

    iget-object v2, p0, Lcom/google/android/gms/common/internal/GetServiceRequest;->j:Landroid/os/IBinder;

    invoke-static {p1, v1, v2}, LVm/i;->Y(Landroid/os/Parcel;ILandroid/os/IBinder;)V

    const/4 v1, 0x6

    iget-object v2, p0, Lcom/google/android/gms/common/internal/GetServiceRequest;->l:[Lcom/google/android/gms/common/api/Scope;

    invoke-static {p1, v1, v2, p2}, LVm/i;->c0(Landroid/os/Parcel;I[Landroid/os/Parcelable;I)V

    const/4 v1, 0x7

    iget-object v2, p0, Lcom/google/android/gms/common/internal/GetServiceRequest;->m:Landroid/os/Bundle;

    invoke-static {v1, v2, p1}, LVm/i;->W(ILandroid/os/Bundle;Landroid/os/Parcel;)V

    const/16 v1, 0x8

    iget-object v2, p0, Lcom/google/android/gms/common/internal/GetServiceRequest;->n:Landroid/accounts/Account;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/internal/GetServiceRequest;->p:[Lcom/google/android/gms/common/Feature;

    invoke-static {p1, v1, v2, p2}, LVm/i;->c0(Landroid/os/Parcel;I[Landroid/os/Parcelable;I)V

    const/16 p2, 0xc

    invoke-static {p1, p2, v3}, LVm/i;->e0(Landroid/os/Parcel;II)V

    iget-boolean p2, p0, Lcom/google/android/gms/common/internal/GetServiceRequest;->q:Z
    ...
    iget p2, p0, Lcom/google/android/gms/common/internal/GetServiceRequest;->r:I
    ...
    iget-object p0, p0, Lcom/google/android/gms/common/internal/GetServiceRequest;->t:Ljava/lang/String;
...
.method public final createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    sget-object v2, Lcom/google/android/gms/common/internal/GetServiceRequest;->u:[Lcom/google/android/gms/common/api/Scope;
    ...
    invoke-static {v0, v2, v3}, LF/a;->p(Landroid/os/Parcel;ILandroid/os/Parcelable$Creator;)[Ljava/lang/Object;
    ...
    :pswitch_8
    invoke-static {v2, v0}, LF/a;->i(ILandroid/os/Parcel;)Landroid/os/Bundle;
