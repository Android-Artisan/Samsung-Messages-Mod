...
.method static constructor <clinit>()V
    ...
    sput-object v0, LOk/p1;->a:Ltl/c;

    return-void
.end method

.method public static final a(LLk/c;)LOk/A;
    .locals 1
    ...
    invoke-static {p0}, LOk/p1;->b(Ljava/lang/Object;)LOk/n0;
...
.method public static final b(Ljava/lang/Object;)LOk/n0;
    .locals 2
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/e;->compute()LLk/c;
...
.method public static final c(Ljava/lang/Object;)LOk/Q0;
    .locals 2

    instance-of v0, p0, LOk/Q0;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/w;->compute()LLk/c;
...
.method public static final d(LVk/a;)Ljava/util/ArrayList;
    .locals 6
    ...
    invoke-interface {v1}, LVk/c;->q()LUk/e0;

    move-result-object v3

    instance-of v4, v3, LZk/b;

    if-eqz v4, :cond_1

    check-cast v3, LZk/b;

    iget-object v2, v3, LZk/b;->b:Ljava/lang/annotation/Annotation;

    goto :goto_2

    :cond_1
    instance-of v4, v3, LZk/j;

    if-eqz v4, :cond_3

    check-cast v3, LZk/j;

    iget-object v1, v3, LZk/j;->b:Lal/y;

    instance-of v3, v1, Lal/h;
    ...
    iget-object v2, v1, Lal/h;->a:Ljava/lang/annotation/Annotation;

    goto :goto_2

    :cond_3
    invoke-static {v1}, LOk/p1;->j(LVk/c;)Ljava/lang/annotation/Annotation;
    ...
    const-class v5, Lkotlin/jvm/internal/D;
    ...
    invoke-static {v1}, Lrk/p;->b([Ljava/lang/Object;)Ljava/util/List;
...
.method public static final f(Ljava/lang/Class;Lvl/m;Lql/f;Lql/h;Lql/a;LEk/c;)LUk/b;
    .locals 14
    ...
    iget-object v3, v3, Lol/z;->o:Ljava/util/List;
    ...
    iget-object v3, v3, Lol/H;->o:Ljava/util/List;

    goto :goto_0

    :goto_1
    new-instance v13, LHl/s;

    iget-object v4, v2, LZk/i;->a:LHl/p;

    iget-object v6, v4, LHl/p;->b:LUk/G;

    sget-object v2, Lql/i;->a:Lql/i$a;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v8, Lql/i;->b:Lql/i;
    ...
    invoke-direct/range {v3 .. v12}, LHl/s;-><init>(LHl/p;Lql/f;LUk/m;Lql/h;Lql/i;Lql/a;LJl/v;LHl/a0;Ljava/util/List;)V

    new-instance v2, LHl/M;

    invoke-direct {v2, v13}, LHl/M;-><init>(LHl/s;)V

    invoke-interface {v1, v2, p1}, LEk/c;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final g(LUk/d;)LUk/Z;
    .locals 1
...
.method public static final h(LOk/a1;)Z
    .locals 2
...
.method public static final i(Ljava/lang/ClassLoader;Ltl/b;I)Ljava/lang/Class;
    .locals 4
    ...
    invoke-static {p1, v2, v0}, LYl/z;->l(Ljava/lang/String;CC)Ljava/lang/String;
...
.method public static final j(LVk/c;)Ljava/lang/annotation/Annotation;
    .locals 7
    ...
    invoke-static {v3, v5}, LOk/p1;->l(Lzl/g;Ljava/lang/ClassLoader;)Ljava/lang/Object;
    ...
    :cond_6
    invoke-static {v0, p0, v3}, Lz2/j;->i(Ljava/lang/Class;Ljava/util/Map;Ljava/util/List;)Ljava/lang/Object;
...
.method public static final k(LUk/g;)Ljava/lang/Class;
    .locals 2
    ...
    iget-object p0, v0, Lml/F;->b:Lml/D;
    ...
    :cond_0
    instance-of v1, v0, LZk/j;

    if-eqz v1, :cond_1

    check-cast v0, LZk/j;

    iget-object p0, v0, LZk/j;->b:Lal/y;
    ...
    invoke-static {p0, v0, v1}, LOk/p1;->i(Ljava/lang/ClassLoader;Ltl/b;I)Ljava/lang/Class;
...
.method public static final l(Lzl/g;Ljava/lang/ClassLoader;)Ljava/lang/Object;
    ...
    invoke-static {p0}, LOk/p1;->j(LVk/c;)Ljava/lang/annotation/Annotation;
    ...
    iget-object v0, v0, Lzl/z;->c:LLl/N;
    ...
    :cond_2
    iget-object v3, p0, Lzl/g;->a:Ljava/lang/Object;
    ...
    invoke-static {v3, v5}, Lrk/w;->m(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v5, p1}, LOk/p1;->l(Lzl/g;Ljava/lang/ClassLoader;)Ljava/lang/Object;
    ...
    :cond_4
    invoke-static {v3}, LRk/l;->s(LUk/j;)LRk/p;
    ...
    :pswitch_9
    invoke-static {v0}, LRk/l;->z(LLl/N;)Z
    ...
    invoke-static {v0, v5}, LRk/l;->E(LLl/N;Ltl/d;)Z
    ...
    :cond_7
    sget-object v0, LRk/s;->Q:Ltl/d;

    invoke-static {v3, v0}, LRk/l;->b(LUk/g;Ltl/d;)Z
    ...
    invoke-static {p1, v0, v1}, LOk/p1;->i(Ljava/lang/ClassLoader;Ltl/b;I)Ljava/lang/Class;
    ...
    iget-object v0, p0, Lzl/f;->a:Ltl/b;

    iget p0, p0, Lzl/f;->b:I

    invoke-static {p1, v0, p0}, LOk/p1;->i(Ljava/lang/ClassLoader;Ltl/b;I)Ljava/lang/Class;
