...
# static fields
.field public static final j:Lol/M;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lol/M;->l:Lol/a;

    new-instance v0, Lol/M;

    invoke-direct {v0}, Lol/M;-><init>()V

    sput-object v0, Lol/M;->j:Lol/M;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lol/M;->b:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lol/M;->a:Lvl/e;
...
.method public constructor <init>(Lol/I;)V
    ...
    .line 34
    iput-object p1, p0, Lol/M;->a:Lvl/e;
...
.method public constructor <init>(Lvl/f;Lvl/i;)V
    ...
    iput-object v0, p0, Lol/M;->b:Ljava/util/List;
    ...
    iput-object v5, p0, Lol/M;->b:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, Lol/M;->b:Ljava/util/List;

    sget-object v6, Lol/L;->o:Lol/a;
    ...
    .line 21
    iget-object p2, p0, Lol/M;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lol/M;->b:Ljava/util/List;
    ...
    iput-object p2, p0, Lol/M;->a:Lvl/e;
    ...
    .line 26
    iget-object p1, p0, Lol/M;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lol/M;->b:Ljava/util/List;
...
.method public final a(Lvl/g;)V
    ...
    :goto_0
    iget-object v1, p0, Lol/M;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lol/M;->a:Lvl/e;
...
.method public final getSerializedSize()I
    ...
    :goto_0
    iget-object v2, p0, Lol/M;->b:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lol/M;->a:Lvl/e;
...
.method public final isInitialized()Z
    ...
    :goto_0
    iget-object v3, p0, Lol/M;->b:Ljava/util/List;
    ...
    invoke-virtual {v3}, Lol/L;->isInitialized()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lol/M;->c:B
