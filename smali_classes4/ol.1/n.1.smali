...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lol/n;->c:Ljava/util/List;
...
.method public final e()Lol/o;
    ...
    iget-object v1, p0, Lol/n;->c:Ljava/util/List;

    invoke-static {v1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lol/n;->c:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lol/n;->c:Ljava/util/List;

    iput-object p0, v0, Lol/o;->b:Ljava/util/List;
...
.method public final f(Lol/o;)V
    ...
    :cond_0
    iget-object v0, p1, Lol/o;->b:Ljava/util/List;
    ...
    iget-object v0, p0, Lol/n;->c:Ljava/util/List;
    ...
    iget-object v2, p0, Lol/n;->c:Ljava/util/List;
    ...
    iget-object v1, p1, Lol/o;->b:Ljava/util/List;
...
.method public final g(Lvl/f;Lvl/i;)V
    ...
    :try_start_0
    sget-object v1, Lol/o;->l:Lol/a;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v1, Lol/o;

    invoke-direct {v1, p1, p2}, Lol/o;-><init>(Lvl/f;Lvl/i;)V
    :try_end_0
    .catch Lvl/s; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p0, v1}, Lol/n;->f(Lol/o;)V
