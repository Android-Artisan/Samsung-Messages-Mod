...
# direct methods
.method public constructor <init>(Ljava/util/Map;LMl/d;LMl/i;LMl/g;LEk/c;)V
    .locals 1
    ...
    iput-object p1, p0, Lxl/x;->a:Ljava/util/Map;

    iput-object p2, p0, Lxl/x;->b:LMl/d;

    iput-object p3, p0, Lxl/x;->c:LMl/i;

    iput-object p4, p0, Lxl/x;->d:LMl/g;

    iput-object p5, p0, Lxl/x;->e:LEk/c;
...
.method public final Y(LPl/e;)LLl/t0;
    ...
    invoke-virtual {p0, p1}, Lxl/x;->e0(LPl/e;)LLl/W;
...
.method public final h0(LPl/f;)Z
    ...
    invoke-virtual {p0, p1}, Lxl/x;->i(LPl/f;)LPl/c;
...
.method public final j0(LPl/e;)Z
    ...
    invoke-virtual {p0, p1}, Lxl/x;->h(LPl/e;)LLl/W;
...
.method public final l0(LPl/i;LPl/i;)Z
    ...
    check-cast p2, LLl/t0;

    iget-object v0, p0, Lxl/x;->b:LMl/d;

    invoke-interface {v0, p1, p2}, LMl/d;->a(LLl/t0;LLl/t0;)Z
    ...
    :cond_0
    iget-object p0, p0, Lxl/x;->a:Ljava/util/Map;
...
.method public final m(LPl/f;)Z
    ...
    invoke-virtual {p0, p1}, Lxl/x;->Y(LPl/e;)LLl/t0;
...
.method public final o(LLl/A0;)LLl/M0;
    ...
    invoke-virtual {p0, p1}, Lxl/x;->c0(LLl/A0;)Z
