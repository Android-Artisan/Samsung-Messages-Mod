...
.method static constructor <clinit>()V
    ...
    sput-object v0, LDj/B1;->g:Ljava/lang/RuntimeException;

    return-void
.end method

.method public constructor <init>(LDj/C1;LDj/v1;Ljava/lang/ref/ReferenceQueue;Ljava/util/concurrent/ConcurrentHashMap;)V
    .locals 2
    ...
    iput-object p1, p0, LDj/B1;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p1, Ljava/lang/ref/SoftReference;

    sget-boolean v0, LDj/B1;->f:Z
    ...
    :cond_0
    sget-object v0, LDj/B1;->g:Ljava/lang/RuntimeException;

    :goto_0
    invoke-direct {p1, v0}, Ljava/lang/ref/SoftReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, LDj/B1;->d:Ljava/lang/ref/SoftReference;

    invoke-virtual {p2}, LDj/v1;->toString()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, LDj/B1;->c:Ljava/lang/String;

    iput-object p3, p0, LDj/B1;->a:Ljava/lang/ref/ReferenceQueue;

    iput-object p4, p0, LDj/B1;->b:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p3}, LDj/B1;->a(Ljava/lang/ref/ReferenceQueue;)V
...
.method public static a(Ljava/lang/ref/ReferenceQueue;)V
    ...
    check-cast v0, LDj/B1;

    if-eqz v0, :cond_1

    iget-object v1, v0, LDj/B1;->d:Ljava/lang/ref/SoftReference;
    ...
    iget-object v3, v0, LDj/B1;->b:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v3, v0}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {v1}, Ljava/lang/ref/Reference;->clear()V

    iget-object v1, v0, LDj/B1;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v3, LDj/C1;->d:Ljava/util/logging/Logger;
    ...
    iget-object v0, v0, LDj/B1;->c:Ljava/lang/String;
...
.method public final clear()V
    ...
    iget-object v0, p0, LDj/B1;->b:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v0, p0}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, LDj/B1;->d:Ljava/lang/ref/SoftReference;

    invoke-virtual {v0}, Ljava/lang/ref/Reference;->clear()V

    iget-object p0, p0, LDj/B1;->a:Ljava/lang/ref/ReferenceQueue;

    invoke-static {p0}, LDj/B1;->a(Ljava/lang/ref/ReferenceQueue;)V
