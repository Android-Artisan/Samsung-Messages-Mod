...
.field private transient reflected:LLk/c;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/e;->getReflected()LLk/c;

    move-result-object p0

    invoke-interface {p0, p1}, LLk/c;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {p0, p1}, LLk/c;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()LLk/c;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/e;->reflected:LLk/c;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/e;->computeReflected()LLk/c;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/e;->reflected:LLk/c;

    :cond_0
    return-object v0
.end method

.method public abstract computeReflected()LLk/c;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {p0}, LLk/b;->getAnnotations()Ljava/util/List;
...
.method public getOwner()LLk/f;
    ...
    invoke-virtual {p0, v0}, Lkotlin/jvm/internal/C;->c(Ljava/lang/Class;)LLk/f;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, LLk/c;->getParameters()Ljava/util/List;
...
.method public getReflected()LLk/c;
    .locals 1
...
.method public getReturnType()LLk/u;
    .locals 0
    ...
    invoke-interface {p0}, LLk/c;->getReturnType()LLk/u;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, LLk/c;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()LLk/z;
    .locals 0
    ...
    invoke-interface {p0}, LLk/c;->getVisibility()LLk/z;
...
.method public isAbstract()Z
    ...
    invoke-interface {p0}, LLk/c;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {p0}, LLk/c;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {p0}, LLk/c;->isOpen()Z
