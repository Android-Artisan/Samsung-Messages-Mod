...
.method public constructor <init>(LKl/o;)V
    ...
    invoke-direct {p0, p1}, LLl/m;-><init>(LKl/o;)V
...
.method public final b(LUk/j;)Z
    ...
    invoke-virtual {p0}, LLl/b;->k()LUk/g;
...
.method public final d()LLl/N;
    ...
    sget-object v2, LRk/s;->a:Ltl/d;

    invoke-static {v0, v2}, LRk/l;->b(LUk/g;Ltl/d;)Z

    move-result v2

    if-nez v2, :cond_1

    sget-object v2, LRk/s;->b:Ltl/d;
    ...
    :cond_0
    invoke-virtual {p0}, LLl/b;->l()LRk/l;
...
.method public final e(Z)Ljava/util/Collection;
    ...
    invoke-virtual {v0, p0}, LVl/k;->add(Ljava/lang/Object;)Z

    :cond_2
    return-object v0
.end method

.method public abstract k()LUk/g;
.end method
...
.method public bridge synthetic m()LUk/j;
    .locals 0
