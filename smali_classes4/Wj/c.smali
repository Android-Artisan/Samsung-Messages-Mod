...
.method public constructor <init>(LLj/j;JLjava/util/concurrent/TimeUnit;LLj/m;)V
    ...
    iput-wide p2, p0, LWj/c;->b:J

    iput-object p4, p0, LWj/c;->c:Ljava/util/concurrent/TimeUnit;

    iput-object p5, p0, LWj/c;->i:LLj/m;
...
.method public final d(LLj/k;)V
    ...
    iget-object p1, p0, LWj/c;->i:LLj/m;

    invoke-virtual {p1}, LLj/m;->a()LLj/m$a;

    move-result-object v5

    iget-wide v2, p0, LWj/c;->b:J

    iget-object v4, p0, LWj/c;->c:Ljava/util/concurrent/TimeUnit;

    move-object v0, v6

    invoke-direct/range {v0 .. v5}, LWj/b;-><init>(Lek/a;JLjava/util/concurrent/TimeUnit;LLj/m$a;)V
